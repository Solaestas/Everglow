...
/// <summary>
/// Pure graphics operations, without involving TModLoader code.
/// </summary>
public static class CollisionUtils
{
    ...
    /// <summary>
    /// Determine whether 2 AABBs intersect.
    /// </summary>
    /// <param name="a"></param>
    /// <param name="b"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Determine whether two AABBs intersect and output the intersecting AABB.
    /// </summary>
    /// <param name="a"></param>
    /// <param name="b"></param>
    ...
    /// <summary>
    /// Determine whether line segments a and b intersect, and output the position of the intersection point on b (ranging from 0 to 1), where 0 represents b.Start.
    /// </summary>
    /// <param name="a"></param>
    /// <param name="b"></param>
    ...
    /// <summary>
    /// Determine whether an Edge intersects an AABB.
    /// </summary>
    ...
    /// <summary>
    /// Determine whether an AABB intersects an Edge.
    /// </summary>
    /// <param name="aabb"></param>
    /// <param name="line"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Return whether the Edge intersects the AABB, and output at most 2 sides of the AABB that the Edge intersects with.
    /// </summary>
    ...
    /// <summary>
    /// Return whether a Circle intersect with an AABB.
    /// </summary>
    ...
    /// <summary>
    /// Return whether a Circle intersect with an AABB, and output a side of the intersected AABB.
    /// </summary>
    /// <param name="circle"></param>
    /// <param name="aabb"></param>
    ...
    /// <summary>
    /// Determine whether two one-dimensional line segments have an intersection.
    /// </summary>
    /// <param name="u0"></param>
    /// <param name="v0"></param>
    /// <param name="u1"></param>
