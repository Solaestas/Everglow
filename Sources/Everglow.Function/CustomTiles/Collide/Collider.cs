...
public class CPoint : Collider
{
	...
	public override AABB AABB => new(Position, 1, 1);
...
public class CCircle : Collider
{
	...
	public override AABB AABB => new(circle.position - new Vector2(circle.radius, circle.radius), new Vector2(circle.radius * 2, circle.radius * 2));
	public override Collider Clone()
	{
