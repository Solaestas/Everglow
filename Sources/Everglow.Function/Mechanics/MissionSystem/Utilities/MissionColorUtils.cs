...
public static class MissionColorUtils
{
	...
	public static Color GetPoolTypeColor(PoolType? poolType) => poolType switch
	{
		...
		PoolType.Overdue => new Color(0.5f, 0f, 0.2f, 0.1f),
		PoolType.Completed => new Color(0.2f, 0.6f, 1f, 0f),
	...
	public static Color GetMissionTypeColor(MissionType? missionType) => missionType switch
	{
		...
		MissionType.SideStory => new Color(0.4f, 0.1f, 1f, 0f),
		...
		MissionType.Achievement => new Color(0.15f, 0.7f, 0.3f, 0f),
		MissionType.Daily => new Color(0f, 0.2f, 1f, 0f),
