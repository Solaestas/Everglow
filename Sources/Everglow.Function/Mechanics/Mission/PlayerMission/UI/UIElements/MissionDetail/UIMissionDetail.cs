...
using static Everglow.Commons.Mechanics.Mission.PlayerMission.UI.MissionContainer;

namespace Everglow.Commons.Mechanics.Mission.PlayerMission.UI.UIElements.MissionDetail;
