...
namespace Everglow.Sources.Commons.Function.Skeleton2D
{
    ...
    internal class RegionAttachment : Attachment
    {
        ...
        public override void Render(Bone2D bone)
        {
            ...
            Vector2 X = Vector2.TransformNormal(Vector2.UnitX, transform);
    ...
    internal class MeshAttachment : Attachment
    {
        ...
        public override void Render(Bone2D bone)
        {
            ...
            foreach (var v in AnimationVertices)
            {
                ...
                targetPos *= (1f / weight);
                Vertex2D vx = new Vertex2D(targetPos - Main.screenPosition, Color.White, new Vector3(v.UV, 0f));
                vertices.Add(vx);
            }
