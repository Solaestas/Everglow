        ...
        private class Buffers : IBuffers
        {
            ...
            public void DrawPrimitive()
            {
                ...
                while (sameTexture.Count != 0)
                {
                    ...
                    graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, currentVertex, currentVertex, nextVertex - currentVertex, currentIndex, (nextIndex - currentIndex) / 3);
