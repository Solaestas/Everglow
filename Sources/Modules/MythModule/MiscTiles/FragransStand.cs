...
namespace Everglow.Sources.Modules.MythModule.MiscTiles
{
    public class FragransStand : ModTile
    {
        public override void PostSetDefaults()
        {
            ...
            modTranslation.SetDefault("Moon Fragrans");
            modTranslation.AddTranslation((int)GameCulture.CultureName.Chinese, "天外之月");
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            {
                Over--;
                string Tex1 = "RightClick will consume 300 fragrans soul to start a random prize\n       Now you have ";
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            //player.cursorItemIconID = ModContent.ItemType<Items.Tables.FragransSoul>();
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (numbSta < 300)
            {
                string tex = "fragrans soul dosn't enough";
                if (Language.ActiveCulture.Name == "zh-Hans")
                {
                    tex = "金桂之魂不足";
                }
