        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                else
                {
                    ...
                    int gr0 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore0").Type, 1f);
                    ...
                    int gr1 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore1").Type, 1f);
                    Main.gore[gr1].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr2 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore2").Type, 1f);
                    Main.gore[gr2].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr3 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore3").Type, 1f);
                    Main.gore[gr3].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr4 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore4").Type, 1f);
                    Main.gore[gr4].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr5 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore5").Type, 1f);
                    Main.gore[gr5].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr6 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore6").Type, 1f);
                    Main.gore[gr6].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr7 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore5").Type, 1f);
                    Main.gore[gr7].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr8 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore6").Type, 1f);
                    Main.gore[gr8].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr9 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore5").Type, 1f);
                    Main.gore[gr9].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr10 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore6").Type, 1f);
                    Main.gore[gr10].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr11 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore5").Type, 1f);
                    Main.gore[gr11].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr12 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore6").Type, 1f);
                    Main.gore[gr12].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr13 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore7").Type, 1f);
                    Main.gore[gr13].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr14 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore8").Type, 1f);
                    Main.gore[gr14].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr15 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore9").Type, 1f);
                    Main.gore[gr15].timeLeft = 900;
                    vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                    vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                    int gr16 = Gore.NewGore(null, NPC.position + new Vector2(60 + Main.rand.NextFloat(-60, 60f), 40 + Main.rand.NextFloat(-60, 60f)), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore10").Type, 1f);
                    Main.gore[gr16].timeLeft = 900;
                    for (int i = 0; i < 8; i++)
                    {
                        vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                        vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                        int gr17 = Gore.NewGore(null, NPC.position + new Vector2(Main.rand.NextFloat(-60, 60f), 40), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore11").Type, 1f);
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                        vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                        int gr18 = Gore.NewGore(null, NPC.position + new Vector2(Main.rand.NextFloat(-60, 60f), 40), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore12").Type, 1f);
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        vFX = Main.rand.NextFloat(-0.4f, 0.4f);
                        vF = new Vector2(vFX, -(float)(Math.Cos(vFX * Math.PI)) * 6f);
                        int gr19 = Gore.NewGore(null, NPC.position + new Vector2(Main.rand.NextFloat(-60, 60f), 40), vF, ModContent.Find<ModGore>("Everglow/Sources/Modules/MythModule/LanternMoon/Gores/LanternGhostKingGore12").Type, 1f);
