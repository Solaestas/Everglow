...
{
    class RedFlame0Split : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 120)
            {
                ...
                for (int h = 0; h < 7; h++)
                {
                    ...
                    Projectile.NewProjectile(null, Projectile.Center, vm + Projectile.velocity, ModContent.ProjectileType<Projectiles.DashCore.RedFlame0Little>(), Projectile.damage, 0, Main.myPlayer, 0, 0);
                }
                Projectile.Kill();
            }
            kb *= 0.97f;
