...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Typeless
{
	public class OrangeStar : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "橙星");
        }
        ...
        int[] Ty = { ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransBlade>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransBow>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransStaff>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransMagic>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransSpear>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransBoomerang>(), ModContent.ItemType<MiscItems.Weapons.Fragrans.FragransGun>() };
        int[] Ty2 = { ModContent.ItemType<MiscItems.FixCoins.FixCoinDamage5>(), ModContent.ItemType<MiscItems.FixCoins.FixCoinCrit5>(), ModContent.ItemType<MiscItems.FixCoins.FixCoinDefense5>() };
