        ...
        public override void PostDraw(Color lightColor)
        {
            for (int j = 0; j < 5; j++)
            {
                ...
                if (bars.Count > 2)
                {
                    ...
                    Texture2D Orange = ModContent.Request<Texture2D>("MythMod/UIImages/heatmapGoldYellow").Value;
            ...
            Texture2D Light = ModContent.Request<Texture2D>("Everglow.Sources.Modules.MythModule.MiscProjectiles.Typeless/FixCoinLight5").Value;
