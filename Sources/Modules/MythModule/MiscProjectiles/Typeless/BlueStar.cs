...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Typeless
{
    public class BlueStar : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "蓝星");
        }
        ...
        private Effect ef;
        public override void PostDraw(Color lightColor) // Note: Error appeared: Object Reference Not Set to an Instance of an Object
        {
