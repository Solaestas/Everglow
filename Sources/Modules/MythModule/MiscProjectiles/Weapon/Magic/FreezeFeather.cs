...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Magic
{
    public class FreezeFeather : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int r = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4) + Projectile.velocity / Projectile.velocity.Length() * 12f, 0, 0, ModContent.DustType<MiscDusts.Freeze>(), 0, 0, 0, default(Color), 4f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int k = 0; k <= 2; k++)
            {
                ...
                int num4 = Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Magic.FreezeBallBrake>(), Projectile.damage / 5, 1, Projectile.owner, 0f, 10f);
            ...
            for (int j = 0; j < 8; j++)
            {
                ...
                int r = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4) + v1, 0, 0, ModContent.DustType<MiscDusts.Freeze>(), v3.X, v3.Y, 0, default(Color), 6f);
                Main.dust[r].noGravity = true;
