        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft > 1 && Projectile.timeLeft < 100)
            {
                if (Projectile.timeLeft % 1 == 0)
                {
                    ...
                    {
                        int r = Dust.NewDust(Projectile.Center - new Vector2(4, 4), 0, 0, ModContent.DustType<MiscDusts.Ice>(), 0, 0, 0, default(Color), 5);
                    ...
                    {
                        int r = Dust.NewDust(Projectile.Center - new Vector2(4, 4), 0, 0, ModContent.DustType<MiscDusts.Ice>(), 0, 0, 0, default(Color), Projectile.timeLeft / 25f);
                        Main.dust[r].velocity.X = 0;
                        Main.dust[r].velocity.Y = 0;
                        Main.dust[r].noGravity = true;
                        Main.dust[r].rotation = (float)Math.Atan2(Projectile.velocity.Y, Projectile.velocity.X);
            ...
            if (Jnj2 > 0)
            {
                int r = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4), 0, 0, ModContent.DustType<MiscDusts.Freeze>(), 0, 0, 0, default(Color), 10f);
                Main.dust[r].noGravity = true;
            }
            Projectile.tileCollide = false;
        }
