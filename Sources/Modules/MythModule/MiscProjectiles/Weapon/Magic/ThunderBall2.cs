    ...
    public class ThunderBall2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(8) == 1)
            {
                ...
                int h = Projectile.NewProjectile(null, Projectile.Center - v, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Magic.ThunderBall2>(), Projectile.damage / 2, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Magic) * 100 + 16);
