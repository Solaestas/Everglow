        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 9 == Ran)
            {
                if (Projectile.ai[0] >= 1)
                {
                    ...
                    int h = Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.RainArrow>(), Projectile.damage / 2, Projectile.knockBack * 2 / 3f, Projectile.owner, Projectile.ai[0] - 1, 0f);
