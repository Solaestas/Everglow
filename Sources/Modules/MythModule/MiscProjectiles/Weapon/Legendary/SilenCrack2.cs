...
{
    public class SilenCrack2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                if (!Filters.Scene["SLECR2"].IsActive())
                {
                    Filters.Scene.Activate("SLECR2");
                }
            }
            if (Projectile.timeLeft < 25)
            {
                if (Filters.Scene["SLECR2"].IsActive())
                {
                    Filters.Scene.Deactivate("SLECR2");
                    ef2.Parameters["Strds"].SetValue(0);
                    ef2.Parameters["DMax"].SetValue(0.001f);
                    Projectile.Kill();
                }
            }
            ef2 = (Effect)ModContent.Request<Effect>("Everglow/Sources/Modules/MythModule/Effects/SilenceCrack2").Value;
