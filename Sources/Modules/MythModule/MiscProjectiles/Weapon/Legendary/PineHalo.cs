...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Legendary
{
    public class PineHalo : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Legendary/GreenHalo").Value;
            ...
            t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Legendary/GreenHalo").Value;
            Main.graphics.GraphicsDevice.Textures[0] = t;
