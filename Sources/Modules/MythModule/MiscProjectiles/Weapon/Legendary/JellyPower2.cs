...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Legendary
{
	public class JellyPower2 : ModProjectile
    {
        ...
        {
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Legendary/JellyPower2").Value;
            Texture2D t2 = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Legendary/JellyPowerL2").Value;
