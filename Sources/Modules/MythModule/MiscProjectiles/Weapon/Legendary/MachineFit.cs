	...
	public class MachineFit : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int j = 0; j < 5; j++)
            {
                ...
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.MachineFitMissile>(), Projectile.damage, 1, Main.myPlayer, Projectile.ai[0], 0f);
            }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Legendary/MachineFit_Glow").Value;
