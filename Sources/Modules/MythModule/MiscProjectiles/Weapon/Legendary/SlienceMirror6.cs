    ...
    class SlienceMirror6 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 654)
            {
                ...
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), vnp0 - vnp1 * 70f, vnp1 * 4.6f, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.SilenCrack>(), Projectile.damage, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Melee) + 25, 0f);
            }
            if (Projectile.timeLeft == 542)
            {
                ...
                vnp1 = vnp1 / vnp1.Length() * 10f;
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), vnp0 - vnp1 * 70f, vnp1 * 4.6f, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.SilenCrack2>(), Projectile.damage, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Melee) + 25, 0f);
            }
            if (Projectile.timeLeft == 428)
            {
                ...
                vnp1 = vnp1 / vnp1.Length() * 10f;
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), vnp0 - vnp1 * 70f, vnp1 * 4.6f, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.SilenCrack3>(), Projectile.damage, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Melee) + 25, 0f);
            }
            if (Projectile.timeLeft == 316)
            {
                ...
                vnp1 = vnp1 / vnp1.Length() * 10f;
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), vnp0 - vnp1 * 70f, vnp1 * 4.6f, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.SilenCrack4>(), Projectile.damage, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Melee) + 25, 0f);
            }
            ...
            if (Projectile.timeLeft == 110)
            {
                ...
                vnp1 = vnp1 / vnp1.Length() * 10f;
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), vnp0 - vnp1 * 70f, vnp1 * 4.6f, ModContent.ProjectileType<MiscProjectiles.Weapon.Legendary.SilenCrack6>(), Projectile.damage, Projectile.knockBack, player.whoAmI, player.GetCritChance(DamageClass.Melee) + 25, 0f);
            }
        }
