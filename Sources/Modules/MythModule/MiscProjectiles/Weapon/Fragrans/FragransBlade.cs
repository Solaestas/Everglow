    ...
    class FragransBlade : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 140)
            {
                ...
                Projectile.NewProjectile(null, player.Center, new Vector2(1 / ka / ka, 0).RotatedBy(Prot) * Pdir, ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransLight>(), (int)(Dam), Projectile.knockBack, player.whoAmI, ka, 15 + player.GetCritChance(DamageClass.Melee));
            }
