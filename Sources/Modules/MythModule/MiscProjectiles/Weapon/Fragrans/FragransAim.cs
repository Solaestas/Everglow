...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Fragrans
{
	public class FragransAim : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), vPos, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransArrowSuper>(), (int)Projectile.ai[1], 15, Main.myPlayer, Projectile.ai[0], 0f);
        }
    }
}
