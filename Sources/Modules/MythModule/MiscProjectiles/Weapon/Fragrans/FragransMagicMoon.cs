	...
	public class FragransMagicMoon : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int j = 0; j < 6; j++)
            {
                ...
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, v, ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransMagicMoon2>(), Projectile.damage / 2, 1, Main.myPlayer, Projectile.ai[0], 0f);
            }
        }
