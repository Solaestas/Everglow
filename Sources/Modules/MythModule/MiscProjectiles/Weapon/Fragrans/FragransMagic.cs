...
namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Fragrans
{
	public class FragransMagic : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectileDirect(null, Projectile.Center, new Vector2(0, 0.7f * Sc).RotatedByRandom(2d * Math.PI), ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransPedal>(), Projectile.damage, Projectile.knockBack, player.whoAmI, Sc);
        }
