    ...
    class Fragrans : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Reset > 0)
            {
                ...
                if (power > 7500)
                {
                    player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransIII>(), Projectile.timeLeft);
                }
                else
                {
                    if (power > 2400)
                    {
                        player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransII>(), Projectile.timeLeft);
                    }
                    else
                    {
                        player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragrans>(), Projectile.timeLeft);
                    }
                }
                if (!Dummy)
                {
            ...
            {
                MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd += 0.25f;
                MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd += 15;
            }
            if (power >= 4)
            {
                power -= 4;
            ...
            if (power > 2400)
            {
                if (power > 7500)
                {
                    ...
                    {
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex = 3;
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd += 0.25f;
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd += 15;
                        player.ClearBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransII>());
                        player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransIII>(), Projectile.timeLeft);
                    }
                    MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex = 3;
                }
                else
                {
                    ...
                    {
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex = 2;
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd += 0.25f;
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd += 15;
                        player.ClearBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragrans>());
                        player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransII>(), Projectile.timeLeft);
                    }
                    if (MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex > 2)
                    {
                        ...
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd -= 0.25f;
                        MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd -= 15;
                        player.ClearBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransIII>());
                        player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransII>(), Projectile.timeLeft);
                    }
                    MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex = 2;
                }
            ...
            else
            {
                if (MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex == 2)
                {
                    MiscProjectiles.Weapon.Fragrans.Fragrans.FragransIndex = 1;
                    MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd -= 0.25f;
                    MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd -= 15;
                    player.ClearBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragransII>());
                    player.AddBuff(ModContent.BuffType<MiscBuffs.Fragrans.MoonAndFragrans>(), Projectile.timeLeft);
        ...
        {
            MiscProjectiles.Weapon.Fragrans.Fragrans.FragDamageAdd = 0;
            MiscProjectiles.Weapon.Fragrans.Fragrans.FragCritAdd = 0;
            power = 0;
        }
        public override void PostDraw(Color lightColor)
        {
            Texture2D texture = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Fragrans/Fragrans").Value;
            ...
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Fragrans/Fragransflower").Value;
            for (int i = 0; i < 24; i++)
            {
