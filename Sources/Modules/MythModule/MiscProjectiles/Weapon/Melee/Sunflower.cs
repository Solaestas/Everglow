namespace Everglow.Sources.Modules.MythModule.MiscProjectiles.Weapon.Melee
{
    public class Sunflower : ModProjectile
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Melee/Sunflower_Glow").Value;
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscProjectiles/Weapon/Melee/Sunflower").Value;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (Projectile.frame < 4)
            {
                for (int t = 0; t < 4; t++)
                {
                    ...
                    int y = Projectile.NewProjectile(Projectile.InheritSource(Projectile), v1.X, v1.Y, v2.X, v2.Y, ModContent.ProjectileType<MiscProjectiles.Weapon.Melee.SunFlowerpetal>(), Projectile.damage / 2, 0.5f, Main.myPlayer);
