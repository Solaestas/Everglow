...
{
    public class PhatomTusk0 : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            VMax[0] = new Vector2(0, 84).RotatedBy(NPC.rotation);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            float Sc = V[5].X;
            Main.spriteBatch.Draw(tb, V[4] - Main.screenPosition + new Vector2(6, -4) - new Vector2(0, 42) + new Vector2(0, 48).RotatedBy(NPC.rotation), null, color2, NPC.rotation, new Vector2(tb.Width / 2f, tb.Height / 2f), Sc, SpriteEffects.None, 0f);
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/TheTusk/NPCs/Bosses/BloodTusk/Tuskplus" + RamInt.ToString()).Value;
            if (Dir > 50)
            {
                Main.spriteBatch.Draw(t, NPC.position - Main.screenPosition + new Vector2(10, 0) + V[0], new Rectangle(0, 0, t.Width, t.Height - (int)V[0].Y), color, NPC.rotation, new Vector2(t.Width / 2f, t.Height / 2f), 1f, SpriteEffects.None, 0f);
            }
            else
            {
                Main.spriteBatch.Draw(t, NPC.position - Main.screenPosition + new Vector2(10, 0) + V[0], new Rectangle(0, 0, t.Width, t.Height - (int)V[0].Y), color, NPC.rotation, new Vector2(t.Width / 2f, t.Height / 2f), 1f, SpriteEffects.FlipHorizontally, 0f);
            }
            return false;
        }
    }
