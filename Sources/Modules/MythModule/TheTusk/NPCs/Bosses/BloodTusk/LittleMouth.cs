...
namespace Everglow.Sources.Modules.MythModule.TheTusk.NPCs.Bosses.BloodTusk
{
    public class LittleMouth : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D t1 = ModContent.Request<Texture2D>("MythMod/NPCs/BloodTusk/LittleMouth1").Value;
            ...
            Texture2D t2 = ModContent.Request<Texture2D>("MythMod/NPCs/BloodTusk/LittleMouth2").Value;
