...
{
    public class TuskWallLeft : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                if (player.Center.X < NPC.Right.X - 150)
                {
            ...
            {
                if (player.Center.X < NPC.Right.X - 40)
                {
                    if (player.velocity.X < 0)
                    {
                        player.velocity.X = 1;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            BloodTusk.FogSpace[2] = NPC.Center + new Vector2(-66, 432);
            BloodTusk.FogSpace[3] = NPC.Center + new Vector2(-127, 260);
            BloodTusk.FogSpace[4] = NPC.Center + new Vector2(-169, 67);
            BloodTusk.FogSpace[5] = NPC.Center + new Vector2(-198, -131);
            BloodTusk.FogSpace[6] = NPC.Center + new Vector2(-203, -313);
            BloodTusk.FogSpace[7] = NPC.Center + new Vector2(-100, -563);
            Color color = Lighting.GetColor((int)(NPC.Center.X / 16d), (int)(NPC.Bottom.Y / 16d));
            color = NPC.GetAlpha(color) * ((255 - NPC.alpha) / 255f);
            Texture2D t = ModContent.Request<Texture2D>("MythMod/NPCs/BloodTusk/TuskWallLeft").Value;
