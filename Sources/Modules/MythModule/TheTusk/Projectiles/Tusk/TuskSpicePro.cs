...
namespace Everglow.Sources.Modules.MythModule.TheTusk.Projectiles.Tusk
{
    public class TuskSpicePro : ModProjectile
    {
        ...
        {
            CyanStrike = 1;
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), target.Center, Vector2.Zero, ModContent.ProjectileType<MiscProjectiles.Weapon.XiaoHit>(), 0, 0, Projectile.owner, 0.45f);
        ...
        private void DrawTusk(On.Terraria.Main.orig_DoDraw_Tiles_NonSolid orig, Terraria.Main self)
        {
