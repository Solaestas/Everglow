...
namespace Everglow.Sources.Modules.MythModule.TheTusk.Projectiles.Tusk
{
    public class TuskCurse : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            ef = (Effect)ModContent.Request<Effect>("MythMod/Effects/ef2/TuskFlame").Value;
            ...
            if (bars.Count > 2)
            {
                ...
                Main.graphics.GraphicsDevice.Textures[0] = ModContent.Request<Texture2D>("MythMod/UIImages/heatmapBloodTusk").Value;
                Main.graphics.GraphicsDevice.Textures[1] = ModContent.Request<Texture2D>("MythMod/UIImages/FogTrace").Value;
                Main.graphics.GraphicsDevice.Textures[2] = ModContent.Request<Texture2D>("MythMod/UIImages/Metero").Value;
