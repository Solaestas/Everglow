...
{
    public class TitaniumClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Titanium Club");
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 7000;
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<Projectiles.TitaniumClub>();
