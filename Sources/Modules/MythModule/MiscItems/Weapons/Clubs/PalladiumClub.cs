...
{
    public class PalladiumClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Palladium Club");
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 2200;
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<Projectiles.PalladiumClub>();
