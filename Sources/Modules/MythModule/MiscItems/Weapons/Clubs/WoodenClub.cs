...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons.Clubs
{
    public class WoodenClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "木棍");
        ...
        public override void SetDefaults()
        {
            ...
            Item.knockBack = 4f;//knockBack
            //Item.UseSound = SoundID.Item1;
            Item.autoReuse = true;
            Item.crit = 0;
            Item.value = 50;
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<Projectiles.WoodenClub>();
