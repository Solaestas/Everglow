...
{
    public class TungstenClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tungsten Club");
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 180;
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<Projectiles.TungstenClub>();
