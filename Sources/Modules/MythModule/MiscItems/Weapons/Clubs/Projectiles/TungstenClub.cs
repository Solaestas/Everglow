...
{
    public class TungstenClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TungstenClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "钨棍");
        }
        ...
        public override void AI()
        {
            ...
            Projectile.damage = (int)(DOpen * Ome * 2.9411765);
            lz += 1;
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.TungstenClub>())
            {
