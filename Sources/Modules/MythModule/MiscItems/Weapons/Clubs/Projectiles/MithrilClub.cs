...
{
    public class MithrilClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Mithril Club");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "秘银棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.MithrilClub>())
            {
