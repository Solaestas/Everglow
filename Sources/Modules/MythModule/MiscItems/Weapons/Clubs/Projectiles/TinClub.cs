...
{
    public class TinClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TinClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "锡棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.TinClub>())
            {
