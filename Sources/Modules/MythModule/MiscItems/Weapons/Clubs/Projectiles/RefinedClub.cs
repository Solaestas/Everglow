...
{
    public class RefinedClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Adamantite Club");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "精金棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.RefinedClub>())
            {
