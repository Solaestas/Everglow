...
{
    public class GoldClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("GoldClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "金棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.GoldClub>())
            {
