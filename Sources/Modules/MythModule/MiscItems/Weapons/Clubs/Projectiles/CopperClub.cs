...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons.Clubs.Projectiles
{
    public class CopperClub : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("CopperClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "铜棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.CopperClub>())
            {
