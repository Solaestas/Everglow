...
{
    public class IronClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("IronClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "铁棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.IronClub>())
            {
