...
{
    public class CobaltClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("CobaltClub");
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.CobaltClub>())
            {
