...
{
    public class LeadClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("LeadClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "铅棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.LeadClub>())
            {
