...
{
    public class PalladiumClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("PalladiumClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "钯金棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.PalladiumClub>())
            {
