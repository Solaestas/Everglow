...
{
    public class PlatinumClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("PlatinumClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "铂金棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.PlatinumClub>())
            {
