...
{
    public class SpikeClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SpikeClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "尖刺棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.SpikeClub>())
            {
