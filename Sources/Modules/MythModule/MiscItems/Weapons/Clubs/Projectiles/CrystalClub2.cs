...
{
    public class CrystalClub2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft > 100)
            {
                ...
                int num25 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 181, 0, 0, 0, default(Color), 0.8f * Omega * 4f);
            ...
            Lighting.AddLight(Projectile.Center, (float)Projectile.timeLeft / 1200f * 185 / 255f, (float)Projectile.timeLeft / 1200f * 15 / 255f, (float)Projectile.timeLeft / 1200f * 185 / 255f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            for (int y = 0; y < 40; y++)
            {
                int num90 = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4), 4, 4, 181, 0f, 0f, 100, default(Color), Main.rand.NextFloat(1.8f, 3f));
