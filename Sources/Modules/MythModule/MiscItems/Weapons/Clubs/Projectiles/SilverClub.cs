...
{
    public class SilverClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SilverClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "银棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.SilverClub>())
            {
