...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons.Clubs.Projectiles
{
    public class CorruptClub : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("CorruptClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "魔影棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.CorruptClub>())
            {
