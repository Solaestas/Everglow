...
{
    public class CactusClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("CactusClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "仙人掌棍");
        }
        ...
        public override void AI()
        {
            ...
            Projectile.damage = (int)(DOpen * Ome * 3.3334);
            lz += 1;
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.CactusClub>())
            {
