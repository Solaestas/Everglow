...
{
    public class TitaniumClub : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TitaniumClub");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "钛金棍");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 22 && Main.mouseLeft && !p.dead && p.HeldItem.type == ModContent.ItemType<Clubs.TitaniumClub>())
            {
