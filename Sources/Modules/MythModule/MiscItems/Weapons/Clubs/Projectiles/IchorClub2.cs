...
{
    public class IchorClub2 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("IchorClub");
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft > 100)
            {
                ...
                int num25 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 64, 0, 0, 0, default(Color), 1.8f * Omega * 4f);
            ...
            {
                float li = Main.rand.NextFloat(-32f, 32f);
                int num25 = Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(li, li).RotatedBy(Projectile.rotation), 0, 0, 64, 0, 0, 0, default(Color), 1.8f * Projectile.timeLeft / 100f * Omega * 4f);
                Main.dust[num25].noGravity = true;
                Main.dust[num25].noLight = true;
                Main.dust[num25].velocity = new Vector2(li, li).RotatedBy(Math.PI / 2 + Projectile.rotation) * 0.3f * Omega * 2.5f;
            }
            Lighting.AddLight(Projectile.Center, (float)Projectile.timeLeft / 1200f * 114 / 255f, (float)Projectile.timeLeft / 1200f * 37 / 255f, (float)Projectile.timeLeft / 1200f * 0 / 255f);
