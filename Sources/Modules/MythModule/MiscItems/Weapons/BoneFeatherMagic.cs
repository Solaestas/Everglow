...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons
{
    public class BoneFeatherMagic : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<MiscProjectiles.Weapon.Magic.BoneFeather>(); // Shoot a black bolt, also known as the projectile shot from the onyx blaster.
