...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons.Fragrans
{
    public class FragransMagic : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                float ad = 0.3f;
                Projectile.NewProjectileDirect(source, position, velocity.RotatedByRandom(0.3) * Main.rand.NextFloat(0.85f, 1.15f), ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransMagicBeta>(), (int)Dam, knockback, player.whoAmI, ad * Main.rand.NextFloat(0.0f, 0.35f));
            }
            Projectile.NewProjectileDirect(source, position, velocity.RotatedByRandom(0.003) * Main.rand.NextFloat(0.85f, 1.15f) * 3, ModContent.ProjectileType<MiscProjectiles.Weapon.Fragrans.FragransMagicMoon>(), (int)Dam * 2, knockback, player.whoAmI, 0);
            return false;
        }
