...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Weapon.Melee
{
    public class GoldRoundYoyo : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Melee.GoldRound>(), Projectile.damage / 5, 0.2f, Projectile.owner, 0f, 0f);
                Prepos = Projectile.Center;
            }
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Melee/GoldRoundYoyoGlow").Value;
