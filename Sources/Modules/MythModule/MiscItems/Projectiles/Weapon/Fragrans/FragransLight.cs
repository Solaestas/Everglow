	...
	class FragransLight : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            for (int i = 0; i < Range; ++i)
            {
                ...
                {
                    int num90 = Dust.NewDust(Projectile.Center + v3 * (1 + width / 200f) / (float)(Math.Sqrt(ka)), 0, 0, ModContent.DustType<MiscItems.Dusts.Fragrans.Fragrans2>(), 0f, 0f, 0, default(Color), Main.rand.NextFloat(1.0f, 1.3f));
                    Main.dust[num90].noGravity = true;
                    Main.dust[num90].velocity = Projectile.velocity * 5;
                }
            }
