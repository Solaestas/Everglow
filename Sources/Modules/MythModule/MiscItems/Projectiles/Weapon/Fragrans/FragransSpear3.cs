...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Weapon.Fragrans
{
	public class FragransSpear3 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(null, Projectile.Center, Projectile.velocity.RotatedBy(0.3), ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Fragrans.FragransSpear3>(), Projectile.damage, Projectile.knockBack, player.whoAmI, Projectile.ai[0] + 1, 0f);
            }
        }
