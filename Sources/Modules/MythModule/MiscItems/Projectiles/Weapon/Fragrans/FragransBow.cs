namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Weapon.Fragrans
{
	class FragransBow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Main.mouseLeft)
            {
                Projectile.NewProjectile(null, Projectile.Center, v / v.Length() * 30f, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Fragrans.FragransArrow>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 0f);
                Projectile.Kill();
            }
        }
        private Effect ef;
        ...
        {
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Fragrans/FragransArrow").Value;
