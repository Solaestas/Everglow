...
{
    class FragransBlade : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Dir)
            {
                ...
                ka = Main.rand.NextFloat(Main.rand.NextFloat(0.3f, 1f), 1f);
                Dir = true;
            }
            if (Projectile.timeLeft == 140)
            {
                ...
                Projectile.NewProjectile(null, player.Center, new Vector2(1 / ka / ka, 0).RotatedBy(Prot) * Pdir, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Fragrans.FragransLight>(), (int)(Dam), Projectile.knockBack, player.whoAmI, ka, 15 + player.GetCritChance(DamageClass.Melee));
            }
        ...
        {
            Player player = Main.player[Projectile.owner];
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Fragrans/FragransBlade").Value;
