...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Weapon.Legendary
{
    class BloodLightCyanFlame : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<BloodLightCyanFlameHit>(), (int)((double)Projectile.damage), Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
        ...
        {
            Texture2D tg = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Legendary/BloodLightCyanFlameGlow").Value;
            ...
            if (bars.Count > 2)
            {
                ...
                Main.graphics.GraphicsDevice.Textures[2] = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/UIimages/VisualTextures/FlameTrace").Value;
