...
{
    class SlienceMirror3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), player.Center + new Vector2(0, -24), Vector2.One, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Legendary.SlienceMirror4>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 0f, 0f);
            }
        }
