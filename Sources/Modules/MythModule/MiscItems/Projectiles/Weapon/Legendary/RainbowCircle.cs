    ...
    public class RainbowCircle : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (neartokill == 1)
            {
                ...
                int h = Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center - new Vector2(0, 200), Vector2.Zero, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Legendary.Light>(), 0, 0, player.whoAmI, Rt + Gt / 1000f, Bt + Ct / 1000f);
