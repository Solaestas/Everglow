...
{
    class SlienceMirror4 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Dir)
            {
                ...
                Siort = Main.rand.NextFloat(0.84f);
            ...
            {
                Vector2 vnp0 = Main.MouseWorld - new Vector2(0, Main.rand.NextFloat(140f, 245f)).RotatedBy(Main.rand.NextFloat(-0.4f, 0.4f));
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), player.Center + new Vector2(0, -24), Vector2.One, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Legendary.SlienceMirror5>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 0f, 0f);
            }
        }
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int k = 0; k < 50; k++)
            {
                if (k % 15 == 2)
                {
                    Vector2 v3 = v_1.RotatedBy(1.1 / 170d * Math.PI * (340 - Projectile.timeLeft - k) + 0.4) * 3.5f * (1 - (1 - Siort) / 2f);
                    if (Projectile.timeLeft < 30)
                    {
