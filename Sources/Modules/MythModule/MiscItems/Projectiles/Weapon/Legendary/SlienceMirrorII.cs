...
{
    class SlienceMirrorII : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!Dir)
            {
                ...
                Siort = Main.rand.NextFloat(0.5f, 1f);
            ...
            Vector2 v0 = v_1.RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft));
            if (ExtraKnife)
            {
                v0 = v_1.RotatedBy(1.2 / 170d * Math.PI * (310));
            }
            ...
            if (Projectile.timeLeft > 220 && Projectile.timeLeft % 4 == 0)
            {
                Projectile.extraUpdates++;
            }
            if (Projectile.timeLeft < 170 && Projectile.timeLeft % 3 == 0 && ExtraKnife)
            {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ExtraKnife)
            {
                for (int k = 0; k < Projectile.timeLeft - 120; k++)
                {
                    if (k % 15 == 2)
                    {
                        Vector2 v3 = v_1.RotatedBy(1.2 / 170d * Math.PI * (310 - k) + 0.4) * 3.5f * (1 - (1 - Siort) / 2f);
                        if (Projectile.timeLeft < 30)
                        {
            ...
            for (int k = 0; k < 50; k++)
            {
                if (k % 15 == 2)
                {
                    Vector2 v3 = v_1.RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft - k) + 0.4) * 4.5f * (1 - (1 - Siort) / 2f);
                    if (Projectile.timeLeft < 30)
                    {
                        v3 = v_1.RotatedBy(1.6 * Math.PI) * 3.5f * (1 - (1 - Siort) / 2f);
                    }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            int width = 84;
            int Maxz = 160;
            if (340 - Projectile.timeLeft < 160)
            {
                Maxz = 340 - Projectile.timeLeft;
            }
            if (ExtraKnife)
            {
            ...
            if (ExtraKnife)
            {
                for (int i = 1; i < Maxz; ++i)
                {
                    ...
                    Vector2 v3 = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (310 - i)) * 7.6f;
                    if (Projectile.timeLeft < 30)
                    {
                    ...
                    v3.X *= Pdir;
                    Vector2 v4 = new Vector2(v3.X, v3.Y * Siort).RotatedBy(Prot);
                    var normalDir = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (310 - i + 1)) * 7.6f - (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (310 - i)) * 7.6f;
                    if (Projectile.timeLeft < 30)
                    {
                    ...
                    if (!Main.gamePaused)
                    {
                        ...
                        {
                            Projectile.NewProjectile(Projectile.InheritSource(Projectile), player.Center + v4 + normalDir, normalDir.RotatedBy(1.57) * -15f, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Legendary.SlienceMirrorIIBroken>(), Projectile.damage, 1, Main.myPlayer, Projectile.ai[0], 0f);
                        }
                    }
                }
            }
            else
            {
                for (int i = 1; i < Maxz; ++i)
                {
                    ...
                    Vector2 v3 = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft - i)) * 7.6f;
                    if (Projectile.timeLeft < 30)
                    {
                        v3 = (v_1 * 1.0f).RotatedBy(1.6 * Math.PI) * 7.6f;
                    }
                    v3.X *= Pdir;
                    Vector2 v4 = new Vector2(v3.X, v3.Y * Siort).RotatedBy(Prot);
                    var normalDir = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft - i + 1)) * 7.6f - (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft - i)) * 7.6f;
                    if (Projectile.timeLeft < 30)
                    {
                        if (i < 30 - Projectile.timeLeft)
                        {
            ...
            Vector2 v32 = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft)) * 7.6f;
            v32.X *= Pdir;
            ...
            int widtf = 42;
            int Maxh = 240;
            if (340 - Projectile.timeLeft < 240)
            {
                Maxh = 340 - Projectile.timeLeft;
            }
            if (ExtraKnife)
            {
                Maxh = 240;
            ...
            Vector2 v32a = (v_1 * 1.0f).RotatedBy(1.2 / 170d * Math.PI * (340 - Projectile.timeLeft)) * 7.6f;
            v32a.X *= Pdir;
            ...
            if (barz.Count > 2)
            {
                ...
                ef2.Parameters["uTime"].SetValue(-Projectile.ai[1] / 3f);
                float Str = 1;
                if (ExtraKnife)
                {
