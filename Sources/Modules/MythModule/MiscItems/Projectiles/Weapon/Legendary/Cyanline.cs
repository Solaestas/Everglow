    ...
    public class Cyanline : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            for (int g = 0; g < 8; g++)
            {
                ...
                int numk = Dust.NewDust(Projectile.Center - new Vector2(8, 8), 8, 8, ModContent.DustType<MiscItems.Dusts.Poison>(), v.X * Projectile.scale, v.Y * Projectile.scale, 0, default(Color), 4f * Projectile.scale);
