namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Weapon.Legendary
{
    class BloodDarkSmog : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num90 = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4) + new Vector2(29, 29).RotatedBy(Projectile.rotation), 4, 4, ModContent.DustType<MiscItems.Dusts.BlackSmog>(), 0f, 0f, 100, default(Color), Main.rand.NextFloat(1.3f, 9f) * Sc);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Legendary/BloodDark").Value;
