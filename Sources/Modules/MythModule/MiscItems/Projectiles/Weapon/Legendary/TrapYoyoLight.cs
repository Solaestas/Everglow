    ...
    public class TrapYoyoLight : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                int num2 = Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center - v, v, ModContent.ProjectileType<MiscItems.Projectiles.Weapon.Legendary.AuDust>(), Projectile.damage / 8, 0.2f, Main.myPlayer, 0f, 0f);
        ...
        {
            Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Weapon/Legendary/TrapYoyoLight").Value;
