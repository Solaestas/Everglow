...
{
    public class Gear2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Inpos = player.Center - new Vector2(18 * player.direction, 100) - new Vector2(40, 0) + new Vector2(32 * Projectile.ai[0], 0);
            Projectile.position = Projectile.position * 0.498f + Inpos * 0.502f;
            Projectile.rotation -= Ome * 2f;
