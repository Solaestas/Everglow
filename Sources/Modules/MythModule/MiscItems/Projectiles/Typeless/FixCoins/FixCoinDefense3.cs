...
{
    public class FixCoinDefense3 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                ...
                {
                    player.inventory[x].prefix = PrefixID.Warding;
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinDefense3>());
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D Light = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/MiscItems/Projectiles/Typeless/FixCoinLight3").Value;
