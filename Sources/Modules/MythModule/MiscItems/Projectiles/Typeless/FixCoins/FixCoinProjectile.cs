...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Typeless.FixCoins
{
    public abstract class FixCoinProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int type = ModContent.DustType<Dusts.PureWhite>();
            switch (Level())
            {
                case 2: type = ModContent.DustType<Dusts.PureLime>(); break;
                case 3: type = ModContent.DustType<Dusts.PurePurple>(); break;
                case 4: type = ModContent.DustType<Dusts.PureCeleste>(); break;
                case 5: type = ModContent.DustType<Dusts.PureOrange>(); break;
            }
            Color ColorVec = new Color(0.03f, 0.03f, 0.03f, 1);
            switch (Level())
            {
                case 2: ColorVec = new Color(0.1f, 1f, 0.00f, 1); break;
                case 3: ColorVec = new Color(0.0f, 0.0f, 1f, 1); break;
                case 4: ColorVec = new Color(0.5f, 0.0f, 0.8f, 1); break;
                case 5: ColorVec = new Color(1f, 0.8f, 0.00f, 1); break;
            }
            for (int h = 0; h < 20; h++)
            {
        ...
        {
            Vector4 ColorVec = new Vector4(0.03f, 0.03f, 0.03f, 1);

            switch (Level())
            {
                case 2: ColorVec = new Vector4(0.1f, 1f, 0.00f, 1); break;
                case 3: ColorVec = new Vector4(0.0f, 0.0f, 1f, 1); break;
                case 4: ColorVec = new Vector4(0.5f, 0.0f, 0.8f, 1); break;
                case 5: ColorVec = new Vector4(0.8f, 0.6f, 0.00f, 1); break;
            }
            ...
            Texture2D Circle = MythContent.QuickTexture("MiscItems/Projectiles/Typeless/FixCoins/FixCoinFramework");
            Texture2D Light = MythContent.QuickTexture("MiscItems/Projectiles/Typeless/FixCoins/FixCoinLight");
