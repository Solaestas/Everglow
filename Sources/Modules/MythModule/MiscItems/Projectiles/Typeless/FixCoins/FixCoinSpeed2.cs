...
{
    public class FixCoinSpeed2 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                if (player.inventory[x].accessory)
                {
                    ...
                    {
                        player.inventory[x].prefix = PrefixID.Fleeting;
                    }
                    else
                    {
                        player.inventory[x].prefix = PrefixID.Hasty2;
                    }
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinSpeed2>());
