...
{
    public class FixCoinCrit4 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                if (player.inventory[x].accessory)
                {
                    ...
                    {
                        //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Eaglely1>();
                    }
                    else
                    {
                        //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Eaglely2>();
                    }
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinCrit4>());
