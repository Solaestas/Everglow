...
{
    public class FixCoinDefense2 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                if (player.inventory[x].accessory)
                {
                    ...
                    {
                        player.inventory[x].prefix = PrefixID.Guarding;
                    }
                    else
                    {
                        player.inventory[x].prefix = PrefixID.Armored;
                    }
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinDefense2>());
