...
{
    public class FixCoinDamage5 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                if (player.inventory[x].accessory)
                {
                    ...
                    {
                        //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Bullying1>();
                    }
                    else
                    {
                        if (Main.rand.NextBool(2))
                        {
                            //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Bullying2>();
                        }
                        else
                        {
                            //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Bullying3>();
                        }
                    }
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinDamage5>());
