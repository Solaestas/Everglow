...
{
    public class FixCoinCrit5 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                if (player.inventory[x].accessory)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //player.inventory[x].prefix = ModContent.PrefixType<Prefixs.Locked3>();
                        }
                    }
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinCrit5>());
