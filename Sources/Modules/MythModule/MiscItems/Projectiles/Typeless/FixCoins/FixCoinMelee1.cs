...
{
    public class FixCoinMelee1 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = X0; x < 58; x++)
            {
                ...
                {
                    player.inventory[x].prefix = PrefixID.Wild;
            ...
            Item.NewItem(null, Projectile.Center, ModContent.ItemType<MiscItems.FixCoins.FixCoinMelee1>());
