...
{
    internal class WaterBoltBook : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.itemTime == 2)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(),Projectile.Center + velocity * 6, velocity, ProjectileID.WaterBolt, player.HeldItem.damage, player.HeldItem.knockBack, player.whoAmI);
            }
        }
        ...
        {
            Player player = Main.player[Projectile.owner];
            Texture2D Book = TextureAssets.Item[ItemID.WaterBolt].Value;
            Texture2D BookGlow = MythContent.QuickTexture("MagicWeaponsReplace/Projectiles/Item_"+ItemID.WaterBolt+"_Glow");
            Texture2D Paper = MythContent.QuickTexture("MagicWeaponsReplace/Projectiles/WaterBolt/WaterBoltPaper");
