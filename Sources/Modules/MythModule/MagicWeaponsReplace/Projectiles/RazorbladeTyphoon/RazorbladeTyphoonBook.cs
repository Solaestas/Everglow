...
{
    internal class RazorbladeTyphoonBook : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.itemTime > 0 && player.HeldItem.type == ItemID.RazorbladeTyphoon)
            {
            ...
            if (player.itemTime == 2)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(),Projectile.Center + velocity * 6, velocity, ProjectileID.Typhoon, player.HeldItem.damage, player.HeldItem.knockBack, player.whoAmI);
            }
        }
        ...
        {
            Player player = Main.player[Projectile.owner];
            Texture2D Book = TextureAssets.Item[ItemID.RazorbladeTyphoon].Value;
            Texture2D BookGlow = MythContent.QuickTexture("MagicWeaponsReplace/Projectiles/Item_" + ItemID.RazorbladeTyphoon + "_Glow");
            Texture2D Paper = MythContent.QuickTexture("MagicWeaponsReplace/Projectiles/RazorbladeTyphoon/RazorbladeTyphoonPaper");
