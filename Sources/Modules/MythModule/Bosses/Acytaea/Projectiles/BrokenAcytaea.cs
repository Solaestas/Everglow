...
namespace Everglow.Sources.Modules.MythModule.Bosses.Acytaea.Projectiles
{
    public class BrokenAcytaea : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Vx.Add(new VertexInfo2(po1 + Projectile.Center - Main.screenPosition, new Color(255, (int)(122.5 + Math.Sin(RamdomC) * 122.5), (int)(122.5 + Math.Sin(RamdomC) * 122.5), 0), new Vector3(0, 0, 0)));
            Vx.Add(new VertexInfo2(po2 + Projectile.Center - Main.screenPosition, new Color(255, (int)(122.5 + Math.Sin(RamdomC) * 122.5), (int)(122.5 + Math.Sin(RamdomC) * 122.5), 0), new Vector3(0, 0, 0)));
            Vx.Add(new VertexInfo2(po3 + Projectile.Center - Main.screenPosition, new Color(255, (int)(122.5 + Math.Sin(RamdomC) * 122.5), (int)(122.5 + Math.Sin(RamdomC) * 122.5), 0), new Vector3(0, 0, 0)));
