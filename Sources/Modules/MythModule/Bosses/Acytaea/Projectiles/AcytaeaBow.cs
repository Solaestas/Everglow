namespace Everglow.Sources.Modules.MythModule.Bosses.Acytaea.Projectiles
{
    class AcytaeaBow : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Texture2D t = ModContent.Request<Texture2D>("MythMod/Projectiles/Acytaea/AcytaeaWarningArrow3").Value;
                ...
                Main.spriteBatch.Draw(t, Projectile.Center - Main.screenPosition, null, new Color(Fade * Fade, Fade * Fade, Fade * Fade, 0), 3.14159f + Projectile.rotation, drawOrigin, Projectile.scale * 2, SpriteEffects.None, 0f);
            }
            return true;
        }
    }
