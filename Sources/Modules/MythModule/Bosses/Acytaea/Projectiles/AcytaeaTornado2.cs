...
{
    class AcytaeaTornado2 : ModProjectile
    {
        ...
        {
            if (WHOAMI >= 0 && Main.projectile[WHOAMI].active && Main.projectile[WHOAMI].type == Typ2)
            {
                for (int z = -3; z < 4; z++)
                {
                    ...
                    for (int h = 0; h < 60; h++)
                    {
                        ...
                        Vx.Add(new VertexBase.CustomVertexInfo(vc - Main.screenPosition + new Vector2(0, z * 200), color3, new Vector3((h + 1) / 60f, 0, 0)));
                        Vx.Add(new VertexBase.CustomVertexInfo(vb - Main.screenPosition + new Vector2(0, z * 200), color3, new Vector3(h / 60f, 0, 0)));
                        Vx.Add(new VertexBase.CustomVertexInfo(Main.projectile[WHOAMI].Center - Main.screenPosition + new Vector2(0, 400) + new Vector2(0, z * 200), color3, new Vector3(0.5f, 1, 0)));
                    }
                    Texture2D t = ModContent.Request<Texture2D>("MythMod/Projectiles/Acytaea/AcytaeaTornado2").Value;
