...
{
    class AcytaeaTornado3 : ModProjectile
    {
        ...
        public static int Typ3 = -1;
        public static void DrawAll(SpriteBatch sb)
        {
            if (WHOAMI >= 0 && Main.projectile[WHOAMI].active && Main.projectile[WHOAMI].type == Typ3)
            {
                for (int z = -15; z < 16; z++)
                {
                    ...
                    for (int h = 0; h < 60; h++)
                    {
                        ...
                        Vector2 vBla = new Vector2(130 * MinCosZ, 0).RotatedBy(Timer - h * 0.1f + z * z);
                        vBla.Y *= 0.3f;
                    ...
                    Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/Bosses/Acytaea/Projectiles/Acytaea/AcytaeaTornado3").Value;
