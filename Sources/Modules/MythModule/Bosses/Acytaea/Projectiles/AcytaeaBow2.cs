...
{
    class AcytaeaBow2 : ModProjectile
    {
        ...
        public override Color? GetAlpha(Color lightColor)
        {
            ...
            {
                return new Color?(new Color((int)(255 * (40 - Projectile.timeLeft) / 20f), (int)(255 * (40 - Projectile.timeLeft) / 20f), (int)(255 * (40 - Projectile.timeLeft) / 20f), 0));
            }
