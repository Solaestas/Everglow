    ...
    public class AcytaeaLaserBall : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            for (int z = 0; z < 7; z++)
            {
                ...
                Texture2D t = ModContent.Request<Texture2D>("Everglow/Sources/Modules/MythModule/Bosses/Acytaea/Projectiles/Acytaea/AcytaeaTornado5").Value;
            ...
            Main.graphics.GraphicsDevice.Textures[0] = ModContent.Request<Texture2D>("MythMod/UIImages/RedBall2").Value;
