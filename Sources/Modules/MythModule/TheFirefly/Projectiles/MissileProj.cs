...
namespace Everglow.Sources.Modules.MythModule.TheFirefly.Projectiles
{
    public class MissileProj : ModProjectile, IWarpProjectile
    {
        ...
        private void HitToAnything()
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<BombShakeWave>(), 0, 0, Projectile.owner, 1, 2f);
            ...
            for (int h = 0; h < 120; h += 3)
            {
                ...
                int r = Dust.NewDust(Projectile.Center - new Vector2(4, 4), 0, 0, ModContent.DustType<Dusts.PureBlue>(), 0, 0, 0, default(Color), 15f * Main.rand.NextFloat(0.7f, 2.9f));
