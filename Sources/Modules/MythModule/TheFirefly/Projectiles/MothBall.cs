    ...
    public class MothBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int h = 0; h < 120; h += 3)
            {
                ...
                int r = Dust.NewDust(new Vector2(Projectile.Center.X, Projectile.Center.Y) - new Vector2(4, 4), 0, 0, ModContent.DustType<TheFirefly.Dusts.PureBlue>(), 0, 0, 0, default(Color), 15f * Main.rand.NextFloat(0.7f, 2.9f));
