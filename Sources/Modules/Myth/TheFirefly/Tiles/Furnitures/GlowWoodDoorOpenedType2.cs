...
public class GlowWoodDoorOpenedType2 : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		CloseDoorID/* tModPorter Note: Removed. Use TileID.Sets.CloseDoorID instead */ = ModContent.TileType<GlowWoodDoorClosedType2>();
	...
	public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
	{
		...
		if (Main.drawToScreen)
			zero = Vector2.Zero;
		Texture2D tex = MythContent.QuickTexture("TheFirefly/Tiles/Furnitures/GlowWoodDoorOpenedType2Glow");
