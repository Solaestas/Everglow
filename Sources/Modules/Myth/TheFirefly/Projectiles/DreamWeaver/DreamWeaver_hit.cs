...
public class DreamWeaver_hit : ModProjectile, IWarpProjectile
{
	...
	public override void PostDraw(Color lightColor)
	{
		...
		DrawTexCircle(timeValue * 24 * Projectile.ai[0], 8 * (1 - timeValue) * Projectile.ai[0], new Color(0.2f * (1 - timeValue) * (1 - timeValue), 0.2f * (1 - timeValue), 1f, 0f), Projectile.Center - Main.screenPosition, Commons.ModAsset.Trail_6.Value);
	}
