...
public class MothEye : ModItem
{
	...
	public override void ModifyTooltips(List<TooltipLine> tooltips)
	{
		if (fireflyBiome.IsBiomeActive(Main.LocalPlayer))
		{
			...
			{
				new(ModIns.Mod, "MothEyeText0", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeText0")),
				new(ModIns.Mod, "MothEyeText1", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeText1")),
				new(ModIns.Mod, "MothEyeText2", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeText2")),
				new(ModIns.Mod, "MothEyeText3", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeText3")),
				new(ModIns.Mod, "MothEyeText4", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeText4")),
		...
		{
			tooltips.Add(new TooltipLine(ModIns.Mod, "MothEyeCriteriaText", Language.GetTextValue("Mods.Everglow.Myth.ExtraTooltip.FireflyItems.MothEyeCriteriaText")));
		}
	}
