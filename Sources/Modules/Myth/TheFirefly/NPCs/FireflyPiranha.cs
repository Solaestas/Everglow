...
public class FireflyPiranha : ModNPC
{
	...
	{
		Texture2D tex = ModAsset.FireflyPiranha_glow.Value;
		spriteBatch.Draw(tex, NPC.Center - screenPos, NPC.frame, new Color(50, 50, 50, 0), NPC.rotation, new Vector2(NPC.frame.Width, NPC.frame.Height) * 0.5f, NPC.scale, NPC.spriteDirection == 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0);
	}
