namespace Everglow.Sources.Modules.MythModule.LanternMoon.Projectiles.DashCore
{
	class GreenFlame1Split : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Vector2 vm = Projectile.velocity.RotatedBy(1.57) * 0.35f;
				Projectile.NewProjectile(null, Projectile.Center, vm, ModContent.ProjectileType<Projectiles.DashCore.GreenFlame0Little>(), Projectile.damage, 0, Main.myPlayer, 0, 0);
				vm = Projectile.velocity.RotatedBy(-1.57) * 0.35f;
				Projectile.NewProjectile(null, Projectile.Center, vm, ModContent.ProjectileType<Projectiles.DashCore.GreenFlame0Little>(), Projectile.damage, 0, Main.myPlayer, 0, 0);
			}
			kb *= 0.97f;
		}
