...
public class BloodLanternGhost_PowerBall : ModProjectile
{
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Main.EntitySpriteDraw(tex, Projectile.Center - Main.screenPosition, null, Lighting.GetColor(Projectile.Center.ToTileCoordinates()) * fade, Projectile.rotation, tex.Size() * 0.5f, Projectile.scale * mulScale, SpriteEffects.None, 0);
		return false;
	}
}