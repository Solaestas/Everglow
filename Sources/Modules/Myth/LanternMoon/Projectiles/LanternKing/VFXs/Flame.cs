...
namespace Everglow.Sources.Modules.MythModule.LanternMoon.Projectiles.LanternKing.VFXs;
...
internal class FlamePipeline : Pipeline
{
...
[Pipeline(typeof(FlamePipeline), typeof(BloomPipeline))]
internal class FlameDust : ShaderDraw
{
	...
	public FlameDust() { }
	public FlameDust(int maxTime, Vector2 position, Vector2 velocity, params float[] ai) : base(position, velocity, ai)
	{
