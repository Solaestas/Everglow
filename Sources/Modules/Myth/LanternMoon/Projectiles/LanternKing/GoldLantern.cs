...
public class GoldLantern : ModProjectile
{
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(1f, 0.8f, 0f, 0) * 0.4f, 0, new Vector2(128f, 128f), K * 2.8f * 6, SpriteEffects.None, 0f);
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(1f, 0.8f, 0f, 0) * 0.4f, (float)(Math.PI * 0.5), new Vector2(128f, 128f), K * 2.8f * Sca * 6 * ka, SpriteEffects.None, 0f);
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(1f, 0.6f, 0f, 0) * 0.4f, (float)(Math.PI * 0.75), new Vector2(128f, 128f), M * 2.8f * Sca * 6 * ka, SpriteEffects.None, 0f);
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(1f, 0.6f, 0f, 0) * 0.4f, (float)(Math.PI * 0.25), new Vector2(128f, 128f), M * 2.8f * Sca * 6 * ka, SpriteEffects.None, 0f);
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(0.8f, 0.4f, 0f, 0) * 0.4f, x * 6f, new Vector2(128f, 128f), (M + K) * 2.8f * Sca * 6 * ka, SpriteEffects.None, 0f);
		Main.spriteBatch.Draw(ModAsset.LightEffect.Value, Projectile.Center - Main.screenPosition, null, new Color(0.8f, 0.4f, 0f, 0) * 0.4f, -x * 6f, new Vector2(128f, 128f), (float)Math.Sqrt(M * M + K * K) * 2.8f * Sca * 6 * ka, SpriteEffects.None, 0f);
		return false;
	}
}