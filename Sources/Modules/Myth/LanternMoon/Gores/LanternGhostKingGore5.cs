...
public class LanternGhostKingGore5 : DissolveGore
{
	public override void OnSpawn()
	{
		texture = ModAsset.LanternGhostKingGore5S.Value;
		DissolveAnimationTexture = ModAsset.LanternGhostKingGore5G.Value;
