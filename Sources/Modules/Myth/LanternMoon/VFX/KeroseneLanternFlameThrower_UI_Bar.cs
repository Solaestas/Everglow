...
public class KeroseneLanternFlameThrower_UI_Bar : Visual
{
	...
	public override void Update()
	{
		...
		else
		{
			...
			if (kThrower is not null)
			{
				...
				HoverButtom = false;
				Vector2 buttomWorldPos = Owner.MountedCenter + new Vector2(0, -40) + new Vector2(78 * ButtonValue - 39, 3);
	...
	public override void Draw()
	{
		...
		Ins.Batch.Draw(tex, drawPos + new Vector2(78 * ButtonValue - 39, 3), buttom, envColor, 0, buttom.Size() * 0.5f, Fade, SpriteEffects.None);
		if(HoverButtom)
		{
			...
			Ins.Batch.Draw(tex, drawPos + new Vector2(78 * ButtonValue - 39, 3), buttom_highlight,hoverColor, 0, buttom_highlight.Size() * 0.5f, Fade, SpriteEffects.None);
		}
	}
}