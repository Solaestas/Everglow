...
public class LanternMoonInvasionEvent : ReplicaEvent
{
	...
	public void Initialization()
	{
		...
		WaveEnemiesType[10] = new List<(int, float)>() { (ModContent.NPCType<EvilLantern>(), 1f), (ModContent.NPCType<BombLantern>(), 0.3f), (ModContent.NPCType<CylindricalLantern>(), 0.3f), (ModContent.NPCType<LargeBloodLanternGhost>(), 0.2f), (ModContent.NPCType<BloodLanternGhost>(), 0.25f), (ModContent.NPCType<GreenFlameLantern>(), 0.15f), (ModContent.NPCType<WizardLantern>(), 0.15f) };
		WaveEnemiesType[11] = new List<(int, float)>() { (ModContent.NPCType<BombLantern>(), 0.3f), (ModContent.NPCType<CylindricalLantern>(), 0.3f), (ModContent.NPCType<LargeBloodLanternGhost>(), 0.2f), (ModContent.NPCType<BloodLanternGhost>(), 0.25f), (ModContent.NPCType<GreenFlameLantern>(), 0.15f), (ModContent.NPCType<WizardLantern>(), 0.15f) };
		WaveEnemiesType[12] = new List<(int, float)>() { (ModContent.NPCType<BombLantern>(), 0.3f), (ModContent.NPCType<CylindricalLantern>(), 0.3f), (ModContent.NPCType<LargeBloodLanternGhost>(), 0.2f), (ModContent.NPCType<BloodLanternGhost>(), 0.25f), (ModContent.NPCType<GreenFlameLantern>(), 0.15f), (ModContent.NPCType<WizardLantern>(), 0.15f) };
