...
internal class AcytaeaArrow2 : ModProjectile
{
	...
	public override void Kill(int timeLeft)
	{
		...
		for (int j = 0; j < 30; j++)
		{
			...
			Dust.NewDust(Projectile.Center - new Vector2(4, 4) + new Vector2(0, Main.rand.NextFloat(0, 8f)).RotatedByRandom(Math.PI * 2), 2, 2, ModContent.DustType<Dusts.RedEffect2>(), v0.X, v0.Y, 0, default, 1.5f * Sca / 100f);
		}
	}
	...
	{
		Texture2D t = ModContent.Request<Texture2D>("Everglow/Myth/Bosses/Acytaea/Projectiles/AcytaeaArrow").Value;
