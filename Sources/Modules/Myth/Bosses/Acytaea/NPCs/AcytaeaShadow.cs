...
public class AcytaeaShadow : ModNPC
{
	...
	public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
	{
		...
		Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Everglow/Myth/Bosses/Acytaea/NPCs/AcytaeaHead").Value, NPC.Center + Vector2.Zero - Main.screenPosition, new Rectangle(0, headFrame * 56, 50, 56), color, NPC.rotation, NPC.Size / 2f, 1f, effects, 0f);
		Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Everglow/Myth/Bosses/Acytaea/NPCs/AcytaeaEye").Value, NPC.Center + Vector2.Zero - Main.screenPosition, new Rectangle(0, headFrame * 56, 50, 56), new Color(255, 255, 255, 0), NPC.rotation, NPC.Size / 2f, 1f, effects, 0f);
		if (MinorDir == 1)
		{
			if (RightArmRot > Math.PI / 2d)
				Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Everglow/Myth/Bosses/Acytaea/NPCs/AcytaeaRightArm").Value, NPC.Center + RightArmPos - Main.screenPosition, null, color, NPC.rotation + RightArmRot, new Vector2(33, 23), 1f, effects, 0f);
