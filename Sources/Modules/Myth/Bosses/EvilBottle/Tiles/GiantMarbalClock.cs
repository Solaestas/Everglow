...
namespace Everglow.Myth.Bosses.EvilBottle.Tiles
{
    public class GiantMarbalClock : ModTile
	{
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/GiantMarbalClockBack"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), color, 0f, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
            ...
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/GiantMarbalClockC"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), color, 0f, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/HourPin"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), color, Tiome / 12f, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
            ...
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/HourPinGlow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), C, Tiome / 12f, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/MinutePin"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), color, Tiome, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
            ...
            Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Tiles/MinutePinGlow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + Vector2.Zero + new Vector2(204, 204), new Rectangle(0, 0, 172, 172), C0, Tiome, new Vector2(86, 86), 1f, SpriteEffects.None, 0f);
        }
    }
}
