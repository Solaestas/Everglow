...
namespace Everglow.Myth.Bosses.EvilBottle.Projectiles
{
    public class EvilShadowBlade : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = MythContent.QuickTexture("Bosses/EvilBottle/Projectiles/EvilShadowBlade");
            ...
            for (int y = 0;y < Times;y++)
            {
                ...
                {
                    Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Items/EvilShadowBlade"), v1 + new Vector2(15, 15) - Main.screenPosition, null, Color.White, Rot2 + (float)(Math.PI / 4d * 3 * p.direction), new Vector2(29, 36), 1, SpriteEffects.None, 0f);
                }
                if (y == 0 && p.direction == -1)
                {
                    Main.spriteBatch.Draw(MythContent.QuickTexture("Bosses/EvilBottle/Items/EvilShadowBlade"), v1 + new Vector2(15, 15) - Main.screenPosition, null, Color.White, Rot2 + (float)(Math.PI / 4d * 3 * p.direction), new Vector2(29, 36), 1, SpriteEffects.FlipHorizontally, 0f);
                }
            }
            if(!Main.gamePaused)
            {
