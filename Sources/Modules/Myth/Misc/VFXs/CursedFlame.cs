...
namespace Everglow.Myth.Misc.VFXs;
...
internal class CursedFlamePipeline : Pipeline
{
	...
	{
		effect = ModContent.Request<Effect>("Everglow/SpellAndSkull/TheFirefly/Projectiles/CursedFlames/CursedFlame", AssetRequestMode.ImmediateLoad);
	}
