...
public class ChlorophyteClub_fly_2 : ModProjectile, IWarpProjectile
{
	...
	public override void AI()
	{
		...
		{
			Vector2 vT0 = Vector2.Normalize(Projectile.velocity);
			Projectile.Center = player.MountedCenter + vT0;
			Projectile.spriteDirection = player.direction;
			if (Projectile.timeLeft == 550)
			{
				Projectile.velocity = vT0.SafeNormalize(Vector2.Zero) * 55 * Projectile.ai[0];
				Projectile.friendly = true;
			}

			float value = (555 - Projectile.timeLeft) / 14f;
	...
	public void DrawTrail()
	{
		...
		if (Projectile.timeLeft > 550)
		{
			float value = (555 - Projectile.timeLeft) / 15f;
