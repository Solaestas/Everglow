...
public class TitaniumClub_smash_explosion : ModProjectile, IWarpProjectile
{
	...
	public override void PostDraw(Color lightColor)
	{
		...
		Vector2 deltaBlue = new Vector2(MathF.Sin((float)Main.time * 0.2f) * 5, 0);
		...
		Color yellow = new Color(0.4f * (1 - timeValue) * (1 - timeValue), 0.4f * (1 - timeValue) * (1 - timeValue), 0.1f * (1 - timeValue) * (1 - timeValue), 0f);
