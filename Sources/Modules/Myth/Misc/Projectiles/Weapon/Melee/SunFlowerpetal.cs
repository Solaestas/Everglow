...
public class SunFlowerpetal : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			Projectile.alpha = 0;
			Lighting.AddLight(Projectile.Center, (255 - Projectile.alpha) * 0.24f / 255f, (255 - Projectile.alpha) * 0.12f / 255f, (255 - Projectile.alpha) * 0f / 255f);
		}
		else
		{
			Lighting.AddLight(Projectile.Center, (255 - Projectile.alpha) * 0.24f / 255f * Projectile.timeLeft / 60f, (255 - Projectile.alpha) * 0.12f / 255f * Projectile.timeLeft / 60f, (255 - Projectile.alpha) * 0f / 255f * Projectile.timeLeft / 60f);
