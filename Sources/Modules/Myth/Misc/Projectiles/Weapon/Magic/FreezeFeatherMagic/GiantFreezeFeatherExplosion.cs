...
public class GiantFreezeFeatherExplosion : ModProjectile, IWarpProjectile
{
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Main.spriteBatch.Draw(light, Projectile.Center - Main.screenPosition, null, new Color(1f * (1 - timeValue) * (1 - timeValue), 1f * (1 - timeValue), 1f, 0f), 0 + Projectile.ai[1], light.Size() / 2f, new Vector2(1f, dark * dark) * Projectile.ai[0] / 4f, SpriteEffects.None, 0);
