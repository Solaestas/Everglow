...
{ 
	...
	public override void PostDraw(Color lightColor)
	{
		...
		Main.spriteBatch.Draw(Shadow, Projectile.Center - Main.screenPosition, null, new Color(1f, 0.5f, 0, 0) * dark, 0, Shadow.Size() / 2f, 2.2f * Projectile.ai[0] / 15f * dark, SpriteEffects.None, 0);
	...
	public void DrawWarp(VFXBatch spriteBatch)
	{
		...
		DrawTexCircle_VFXBatch(spriteBatch, value * 16 * Projectile.ai[0], width * 0.6f * Projectile.ai[0], new Color(colorV, colorV * 0.4f, colorV, 0f), Projectile.Center - Main.screenPosition, t, Math.PI * 0.5);
	}
