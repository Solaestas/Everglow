	...
	public override void PostHurt(Player.HurtInfo info)
	{
		if (CorruptEyeEnable)
		{
			for (int i = 0; i < 5; i++)
			{
				...
				var CursedFlame = Projectile.NewProjectileDirect(Player.GetSource_FromThis(), Player.Center, velocity, ModContent.ProjectileType<CursedFlamesII>(), 60, 1.5f, Player.whoAmI);
