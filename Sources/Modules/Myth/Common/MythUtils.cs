...
public class MythUtils
{
	...
	public static void DrawTexCircle_Warp(VFXBatch spriteBatch, float radious, float width, Color color, Vector2 center, Texture2D tex, double addRot = 0)
	{
		var circle = new List<Vertex2D>();
