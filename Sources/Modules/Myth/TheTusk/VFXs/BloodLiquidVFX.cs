...
[Pipeline(typeof(BloodLiquidPipeline), typeof(BloomPipeline))]
internal class BloodLiquidDust : ShaderDraw
{
	...
	public override void Draw()
	{
		...
		for (int i = 1; i < len; i++)
		{
			...
			var drawcRope = new Color(fx * fx * fx - 0.2f, light.R / 255f, light.G / 255f, light.B / 255f);
			...
			bars[2 * i] = new Vertex2D(oldPos[i] - normal * width, drawcRope, new Vector3(0.2f + ai[0], (i + 15 - len) / 30f + timer / 1500f * velocity.Length(), light.A / 255f));
		}
