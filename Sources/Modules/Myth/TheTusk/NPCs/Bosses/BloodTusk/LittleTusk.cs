...
public class LittleTusk : ModNPC
{
	...
	public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
	{
		...
		BackBase.Add(new Vertex2D(NPC.Bottom + new Vector2(-600 / (VBase.Length() + 1f), 2) - Main.screenPosition, color, new Vector3(0, 1, 0)));
		BackBase.Add(new Vertex2D(NPC.Bottom + new Vector2(0, 2) + VBase - Main.screenPosition, color, new Vector3(0.5f, 0, 0)));
		BackBase.Add(new Vertex2D(NPC.Bottom + new Vector2(600 / (VBase.Length() + 1f), 2) - Main.screenPosition, color, new Vector3(1, 1, 0)));
		...
		{
			new Vertex2D(NPC.Bottom + new Vector2(-12, 2) - Main.screenPosition, color, new Vector3(0, index, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(12, V.Y - 32) - Main.screenPosition, color, new Vector3(1, 0, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(12, 2) - Main.screenPosition, color, new Vector3(1, index, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(-12, V.Y - 32) - Main.screenPosition, color, new Vector3(0, 0, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(12, V.Y - 32) - Main.screenPosition, color, new Vector3(1, 0, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(-12, 2) - Main.screenPosition, color, new Vector3(0, index, 0))
		};
		...
		{
			new Vertex2D(NPC.Bottom + new Vector2(-600 / (VBase.Length() + 1f), 2) - Main.screenPosition, color, new Vector3(0, 1, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(0, 2) + VBase - Main.screenPosition, color, new Vector3(0.5f, 0, 0)),
			new Vertex2D(NPC.Bottom + new Vector2(600 / (VBase.Length() + 1f), 2) - Main.screenPosition, color, new Vector3(1, 1, 0))
		};
