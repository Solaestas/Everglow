...
public class DemoSparkVFX : Visual
{
	...
	{
		//DrawSpark(Color.White, Math.Min(Projectile.timeLeft / 8f, 20f), Common.ModAsset.SparkDark.Value);
		//DrawSpark(new Color(131, 0, 255, 0), Math.Min(Projectile.timeLeft / 8f, 20f), Common.ModAsset.SparkLight.Value);
	}
