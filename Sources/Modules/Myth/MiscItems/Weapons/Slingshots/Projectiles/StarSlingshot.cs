...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Weapons.Slingshots.Projectiles
{
	internal class StarSlingshot : SlingshotProjectile
	{
		...
		public override void DrawString()
		{
			...
			DrawTexLine(Head1, SlingshotStringTail, 1, dColor, Light, MythContent.QuickTexture("MiscItems/Weapons/Slingshots/Projectiles/String"));
			DrawTexLine(Head2, SlingshotStringTail, 1, dColor, Light, MythContent.QuickTexture("MiscItems/Weapons/Slingshots/Projectiles/String"));
			Main.spriteBatch.End();
			Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.Default, RasterizerState.CullNone, null, Main.GameViewMatrix.TransformationMatrix);
