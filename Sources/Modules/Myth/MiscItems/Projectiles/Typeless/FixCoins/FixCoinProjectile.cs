...
namespace Everglow.Sources.Modules.MythModule.MiscItems.Projectiles.Typeless.FixCoins
{
	public abstract class FixCoinProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				case 2:
					type = ModContent.DustType<Dusts.PureLime>();
					break;
				case 3:
					type = ModContent.DustType<Dusts.PurePurple>();
					break;
				case 4:
					type = ModContent.DustType<Dusts.PureCeleste>();
					break;
				case 5:
					type = ModContent.DustType<Dusts.PureOrange>();
					break;
			}
