...
public class AcytaeaFlySwordExplosion : ModProjectile, IWarpProjectile
{
	...
	public override void PostDraw(Color lightColor)
	{
		...
		Main.spriteBatch.Draw(Shadow, Projectile.Center - Main.screenPosition, null, new Color(1f * (1 - timeValue), 0, 0.6f * (1 - timeValue) * (1 - timeValue), 0f) * dark, 0, Shadow.Size() / 2f, 2.2f * Projectile.ai[0] / 15f * dark, SpriteEffects.None, 0);
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Main.spriteBatch.Draw(light, Projectile.Center - Main.screenPosition, null, new Color(1f * (1 - timeValue), 0, 0.6f * (1 - timeValue) * (1 - timeValue), 0f), 0 + Projectile.ai[1], light.Size() / 2f, new Vector2(1f, dark * dark) * Projectile.ai[0] * 0.08f, SpriteEffects.None, 0);
