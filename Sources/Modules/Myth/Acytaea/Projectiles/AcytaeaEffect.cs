using Everglow.Myth.Acytaea.Dusts;
...
internal class AcytaeaEffect : VisualProjectile
{
	...
	public override void AI()
	{
		...
		float DusS = 0.25f;
		if (Projectile.timeLeft is >= 200 and <= 210)
			DusS = 1.2f;
		if (Projectile.timeLeft <= 200)
			DusS = 0.25f;
		Pro = Projectile.timeLeft >= 210 ? (240 - Projectile.timeLeft) * (240 - Projectile.timeLeft) / 3 : 300;
	...
	{
		//TODO Op
		Texture2D tex2 = ModContent.Request<Texture2D>("Everglow/Myth/Acytaea/Dusts/CosmicCrack").Value;
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Texture2D tex2 = ModContent.Request<Texture2D>("Everglow/Myth/Acytaea/Dusts/CosmicCrack2").Value;
