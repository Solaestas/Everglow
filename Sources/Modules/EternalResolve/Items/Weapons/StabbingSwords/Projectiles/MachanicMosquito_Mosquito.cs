...
namespace Everglow.EternalResolve.Items.Weapons.StabbingSwords.Projectiles
{
    public class MachanicMosquito_Mosquito : ModProjectile
    {
		...
		public void Hover()
		{
			...
			Projectile.velocity += Utils.SafeNormalize(aim - Projectile.Center - Projectile.velocity, Vector2.zeroVector) * 0.4f * mulAcc;
		}
		...
		public override void Kill(int timeLeft)
		{
			for(int a = 0;a < 10;a++)
			{
				Dust d = Dust.NewDustDirect(Projectile.Center, 0, 0, DustID.TheDestroyer, 0, 0, 0, default, Main.rand.NextFloat(0.8f, 2f));
				d.noGravity = true;
			}
			if(Blood > 0)
			{
