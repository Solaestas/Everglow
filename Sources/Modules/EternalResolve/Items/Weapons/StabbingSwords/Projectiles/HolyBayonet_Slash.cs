    ...
    public class HolyBayonet_Slash : ModProjectile, IWarpProjectile
    {
		...
		public override void AI()
		{
			...
			if(Main.rand.NextBool(7) && Projectile.timeLeft < 90)
			{
				...
				Dust dust = Dust.NewDustDirect(Projectile.position - Vector2.Normalize(Projectile.velocity) * Main.rand.NextFloat(0f, (120 - Projectile.timeLeft) * 3f) - new Vector2(4), Projectile.width, Projectile.height, ModContent.DustType<HolyDust>(), 0, 0, 0, default, Main.rand.NextFloat(0.95f, 1.2f));
				dust.velocity = vel;
				dust.noGravity = true;
			}
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color light = new Color(1f, 0.85f, 0.3f, 0);
			light *= width / 10f;
