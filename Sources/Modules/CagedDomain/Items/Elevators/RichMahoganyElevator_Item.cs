...
public class RichMahoganyElevator_Item : ModItem
{
	public override string LocalizationCategory => Commons.Utilities.LocalizationUtils.Categories.Placeables;

	public override void SetDefaults()
	{
		Item.DefaultToPlaceableTile(ModContent.TileType<RichMahoganyElevator_Winch>());
		Item.width = 42;
		Item.height = 64;
		Item.value = 20000;
	}
	...
	{
		CreateRecipe()
			.AddIngredient(ItemID.RichMahogany, 40)
