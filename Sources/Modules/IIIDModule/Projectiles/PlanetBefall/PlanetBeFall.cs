        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int f = 0; f < model.faces.Count; f++)
            {
                ...
                Vector3 tangentVector = ModelEntity.CalculateTangentVector(
                    ...
                    model.texCoords[model.faces[f].TextureCoords[2]]);

                Vector3 surfaceNormal = Vector3.Normalize(Vector3.Cross(B - A, C - A));
            ...
            t.Y = -t.Y;
            var modelMatrix = Matrix.CreateRotationY((float)Main.time * 0.01f) * Matrix.CreateTranslation(t);
            ...
            Main.spriteBatch.Draw(modelPipeline.ModelTarget, Projectile.Center - Main.screenPosition - new Vector2(500, 500),
