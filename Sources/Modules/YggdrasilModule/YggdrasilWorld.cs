                    ...
                    for (int x = 0; x < pixelRow.Length; x++)
                    {
                        ...
                        switch (type)//21是箱子
                        {
                            ...
                            case 3://天穹古道建筑
                                ...
                                {
                                    QuickBuild(x, y, "YggdrasilTown/MapIOs/2FolkHouseofWoodAndStoneStrutureTypeA28x11.mapio");
                                }
                                if (pixel.R == 123 && pixel.G == 5 && pixel.B == 255)//FolkHouseofWood＆StoneStruture TypeB  28x11
                                {
                                    QuickBuild(x, y, "YggdrasilTown/MapIOs/2FolkHouseofWoodAndStoneStrutureTypeB28x11.mapio");
                                }
