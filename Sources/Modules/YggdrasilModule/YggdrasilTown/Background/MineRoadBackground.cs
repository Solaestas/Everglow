...
namespace Everglow.Sources.Modules.YggdrasilModule.YggdrasilTown.Background
{
    public class MineRoadBackground : ModSystem
    {
        ...
        private void DrawFarBG(Color baseColor)
        {
            ...
            BackgroundManager.QuickDrawBG(texSky, GetDrawRect(texSky.Size(), 0f, true), baseColor, 170000, 200000);
            BackgroundManager.QuickDrawBG(texC3, GetDrawRect(texClose.Size(), 0.05f, true), baseColor, 170000, 200000, false, false);
            BackgroundManager.QuickDrawBG(texC2, GetDrawRect(texClose.Size(), 0.10f, true), baseColor, 170000, 200000, false, false);
            BackgroundManager.QuickDrawBG(texC1, GetDrawRect(texClose.Size(), 0.15f, true), baseColor, 170000, 200000, false, true);
            BackgroundManager.QuickDrawBG(texClose, GetDrawRect(texClose.Size(), 0.35f, true), baseColor, 170000, 200000);
        }
        /// <summary>
        /// 获取XY向缩放比例
        /// </summary>
