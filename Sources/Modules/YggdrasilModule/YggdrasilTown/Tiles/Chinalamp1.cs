...
namespace Everglow.Sources.Modules.YggdrasilModule.YggdrasilTown.Tiles
{
    public class Chinalamp1 : ModTile
    {
        public override void PostSetDefaults()
        {
            ...
            modTranslation.SetDefault("Traditional Lamp");
            modTranslation.AddTranslation((int)GameCulture.CultureName.Chinese, "古韵台灯");
        }
        ...
        {
            Item.NewItem(null, i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Chinalamp1>());
        }
