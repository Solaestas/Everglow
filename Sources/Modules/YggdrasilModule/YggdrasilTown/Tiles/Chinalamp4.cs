    ...
    public class Chinalamp4 : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (tile.TileFrameX % 54 == 18 && tile.TileFrameY == 0)
            {
                ...
                Texture2D tex = YggdrasilContent.QuickTexture("YggdrasilTown/Tiles/Chinalamp4");
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<Items.Chinalamp4>());
        }
    }
}
