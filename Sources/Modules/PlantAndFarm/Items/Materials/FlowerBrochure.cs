...
public class FlowerBrochure : ModItem
{
	...
	{
		player.GetModPlayer<FBPlayer>().FlowerBrochure = !hideVisual;
	}
}
...
public class FBGlobalTile : GlobalTile
{
	public override void KillTile(int i, int j, int type, ref bool fail, ref bool effectOnly, ref bool noItem)
	{
		if (Main.netMode != NetmodeID.Server &&
			...
			!fail &&
			!effectOnly &&
			!noItem && WorldGen.GetPlayerForTile(i, j).GetModPlayer<FBPlayer>().FlowerBrochure)
		{
