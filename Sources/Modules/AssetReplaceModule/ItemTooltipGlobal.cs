...
namespace Everglow.Sources.Modules.AssetReplaceModule
{
    public class ItemTooltipGlobal : GlobalItem
    {
        ...
        public override bool PreDrawTooltip(Item item, ReadOnlyCollection<TooltipLine> lines, ref int x, ref int y) {
            ...
            int borderWidth = 14;
            int borderHeight = 9;
            Rectangle invBG = new Rectangle(x - borderWidth, y - borderHeight, (int)zero.X + borderWidth * 2, (int)zero.Y + borderHeight + borderHeight / 2);
            // 计算物品大小，调节提示框
            ...
            if (drawableLines.Count > 1) {
                ...
                Vector3 vec = new Vector3(drawableLines[^1].X, Main.screenHeight, 0);
