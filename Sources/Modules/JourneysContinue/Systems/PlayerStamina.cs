namespace Everglow.JourneysContinue.Systems;
public class PlayerStaminaDrawerJC : ModSystem
{
	...
	public override void PostDrawInterface(SpriteBatch spriteBatch)
	{
		...
		p.GetModPlayer<PlayerStaminaJC>().DrawStamina(pos);
	}
}
public class PlayerStaminaJC : ModPlayer
{
