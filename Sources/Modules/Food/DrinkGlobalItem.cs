        ...
        public DrinkGlobalItem()
        {
            m_vanillaDrinkInfos = new Dictionary<int, DrinkInfo>
            {
                ...
                //苹果汁 饱食度5 短时间内60%减伤 
                {
                    ItemID.AppleJuice,
                    new DrinkInfo() {
                       Thirsty = false , BuffType = ModContent.BuffType<AppleJuiceBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },
                 //冰冻香蕉代基里 饱食度5 短时间内不消耗子弹，极大增加远程伤害暴击
                {
                    ...
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<BananaDaiquiriBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },
                 //血腥麝香葡萄 饱食度5 短时间内迅速回血
                {
                    ...
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<BloodyMoscatoBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },
                //奶油苏打水 饱食度5 加8%远程伤害
                {
                    ItemID.CreamSoda,
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<CreamSodaBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },
                //咖啡 饱食度5 加25%铺墙铺砖速度，5%攻速
                {
                    ItemID.CoffeeCup,
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<CoffeeCupBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },
                //果汁 饱食度5 小幅提升大部分属性
                {
                    ItemID.FruitJuice,
                    new DrinkInfo() {
                       Thirsty = false , BuffType = ModContent.BuffType<FruitJuiceBuff>(), BuffTime = new FoodDuration(4, 0, 0)
                    }
                },
                //葡萄汁 饱食度5 短时间内加5召唤栏，加100%召唤物伤害，击退，极其幸运
                {
                    ItemID.GrapeJuice,
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<GrapeJuiceBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },                
                //柠檬水 饱食度5 短时间内远程击退加倍,仇恨值减2400
                {
                    ItemID.Lemonade,
                    new DrinkInfo() {
                        Thirsty = false , BuffType = ModContent.BuffType<LemonadeBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },                
                //桃子果酒 饱食度5 增加心的拾取范围，1生命回复，减8防御
                {
                    ItemID.PeachSangria,
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<PeachSangriaBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },
                //椰林飘香 饱食度5 加5%减伤，2防御，33%反伤
                {
                    ItemID.PinaColada,
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<PinaColadaBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },
                //七彩潘趣酒 饱食度5 加400仇恨值,1召唤栏,减8防御
                {
                    ...
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<PrismaticPunchBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },                
                //清酒 饱食度5 短时间内减18防御，加80%暴击，加80%伤害， 加80%攻速
                {
                    ItemID.Sake,
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<SakeBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                },
                //暗黑奶昔 饱食度5 短时间内80%闪避
                {
                    ...
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<SmoothieofDarknessBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                }, 
                //一杯茶 饱食度5 加2魔力回复，20魔力上限
                {
                    ItemID.Teacup,
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<TeacupBuff>(), BuffTime = new FoodDuration(5, 0, 0)
                    }
                },
                //热带奶昔 饱食度5 短时间内不消耗魔力，加100%魔力攻击，100%暴击
                {
                    ...
                    new DrinkInfo() {
                        Thirsty = false, BuffType = ModContent.BuffType<TropicalSmoothieBuff>(), BuffTime = new FoodDuration(0, 7, 30)
                    }
                }
