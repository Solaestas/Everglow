    ...
    public class FoodGlobalItem : GlobalItem
    {
        ...
        public FoodGlobalItem()
        {
            m_vanillaFoodInfos = new Dictionary<Item_id, FoodInfo>
            {
                ...
                { ItemID.ChocolateChipCookie, new FoodInfo() { Satiety = 10, BuffType = ModContent.BuffType<ChocolateChipCookieBuff>() , BuffTime = 14400 } },
                ...
                { ItemID.PeachSangria, new FoodInfo() { Satiety = 5, BuffType = ModContent.BuffType<PeachSangriaBuff>() , BuffTime = 900 } },
                { ItemID.Pho, new FoodInfo() { Satiety = 20, BuffType = ModContent.BuffType<PhoBuff>() , BuffTime = 28800 } },
                { ItemID.PinaColada, new FoodInfo() { Satiety = 5, BuffType = ModContent.BuffType<PinaColadaBuff>() , BuffTime = 900 } },
                ...
                { ItemID.PrismaticPunch, new FoodInfo() { Satiety = 5, BuffType = ModContent.BuffType<PrismaticPunchBuff>() , BuffTime = 900 } },
                ...
                { ItemID.Sake, new FoodInfo() { Satiety = 10, BuffType = ModContent.BuffType<SakeBuff>() , BuffTime = 14400 } },
