...
public class ArmorPiercingBlasterProjExplosion : ModProjectile, IWarpProjectile
{
	...
	public void DrawWarp(VFXBatch spriteBatch)
	{
		...
		DrawTexCircle_VFXBatch(spriteBatch, MathF.Sqrt(value) * 20, width * 2, new Color(colorV, colorV * 0.6f, colorV, 0f), Projectile.Center - Main.screenPosition, t, Math.PI * 0.5);
	}
