...
public class RustSlingshot_Weapon : SlingshotProjectile
{
	public override void SetDef()
	{
		ShootProjType = ModContent.ProjectileType<RustSlingshot_Projectile>();
		SlingshotLength = 8;
	}
	...
	//	DrawTexLine(Head1, SlingshotStringTail, 1, drawColor, ModAsset.RustSlingshot_String.Value);
	//	DrawTexLine(Head2, SlingshotStringTail, 1, drawColor, ModAsset.RustSlingshot_String.Value);
	//	Main.spriteBatch.End();
	//	Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.Default, RasterizerState.CullNone, null, Main.GameViewMatrix.TransformationMatrix);
	//}
	...
	//	{
	//		new Vertex2D(StartPos + Width, color, new Vector3(0, 0, 0)),
	//		new Vertex2D(StartPos - Width, color, new Vector3(0, 1, 0)),
	//		new Vertex2D(EndPos + Width, color, new Vector3(1, 0, 0)),
	//		new Vertex2D(EndPos - Width, color, new Vector3(1, 1, 0)),
	//	};
