...
public class WiltedForestLamp_Proj_shoot : TrailingProjectile
{
	...
	public override void AI()
	{
		...
		OldVel = Projectile.velocity;
		Vector2 toTarget = Vector2.Normalize(npc.Center - Projectile.Center - Projectile.velocity);
		...
		Vector3 colorLight = new Vector3(0.4f, 0.7f, 0.2f);
		if(TimeTokill > 0)
		{
	...
	public override void DrawTrail()
	{
		...
		for (int i = 1; i < SmoothTrail.Count; ++i)
		{
			...
			Color drawC = Color.Lerp(TrailColor, new Color(0.4f, 0.1f, 0f, 0f), i / (float)SmoothTrail.Count);
			...
			Color coverColor = new Color(0.05f, 0.7f, 0.3f, 0);
