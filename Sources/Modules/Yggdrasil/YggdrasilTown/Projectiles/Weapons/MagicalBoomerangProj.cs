	...
	public override void AI()
	{
		...
		if (Timer > 5 && Main.mouseLeft && Main.mouseLeftRelease)
		{
			...
			for (int i = 0; i < 8; i++)
			{
				...
				Projectile proj = Projectile.NewProjectileDirect(Projectile.GetSource_FromAI(), Projectile.Center, vel, ModContent.ProjectileType<MagicalBoomerangSubProj>(), (int)(Projectile.damage * 0.7), Projectile.knockBack * 0.7f, Projectile.owner);
