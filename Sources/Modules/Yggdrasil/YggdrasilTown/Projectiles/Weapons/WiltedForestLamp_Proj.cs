...
public class WiltedForestLamp_Proj : ModProjectile
{
	...
	public Vector2 MousePos = default;
	...
	public override void AI()
	{
		...
		else
		{
			...
			Vector3 colorLight;
			Color leafColor = new Color(0.1f, 1f, 0.4f, 1);
			float mulRadius = 1f;
	...
	public override void OnKill(int timeLeft)
	{
		...
		for (int x = 0; x < 24; x++)
		{
			Dust d = Dust.NewDustDirect(Projectile.position - new Vector2(4), Projectile.width, Projectile.height, DustID.WitherLightning, 0f, 0f, 0, default, Main.rand.NextFloat(0.4f, 1.6f));
