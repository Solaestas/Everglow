...
public class LightStartEffect_bullet : ModProjectile
{
	...
	public override void AI()
	{
		...
		Lighting.AddLight(Projectile.Center + Utils.SafeNormalize(Projectile.velocity, Vector2.zeroVector) * 20, new Vector3(0.8f, 0.6f, 0) * Projectile.ai[0] * 3);
	}
