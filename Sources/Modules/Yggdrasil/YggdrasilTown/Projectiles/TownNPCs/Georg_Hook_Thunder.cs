...
public class Georg_Hook_Thunder : ModProjectile
{
	...
	public override void OnSpawn(IEntitySource source)
	{
		base.OnSpawn(source);
		FailureVFX(8);
		ShakerManager.AddShaker(Projectile.Center, Vector2.One.RotatedByRandom(MathHelper.Pi), 10, 20f, 120, 0.9f, 0.8f, 150);
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Vector2 hitCenter = Projectile.Center + new Vector2(0, -1000).RotatedBy(Projectile.ai[0]);
		...
		Color drawColor = new Color(0.1f, 0f, 0.2f, 0f) * mulColor;
		Color drawColor2 = new Color(0.5f, 0.7f, 1f, 0f) * mulColor;
		...
		Main.spriteBatch.Draw(point, Projectile.Center - Main.screenPosition, null, new Color(0, Projectile.timeLeft / 60f, Projectile.timeLeft / 30f, 0), 0, point.Size() * 0.5f, 2f, SpriteEffects.None, 0);
		Main.spriteBatch.Draw(point, Projectile.Center - Main.screenPosition, null, new Color(Projectile.timeLeft / 180f, Projectile.timeLeft / 60f, Projectile.timeLeft / 30f, 0), 0, point.Size() * 0.5f, 0.5f, SpriteEffects.None, 0);
		...
		if (Projectile.timeLeft > 25)
		{
			Lighting.AddLight(Projectile.Center, new Vector3(0.2f, 0.5f, 1f) * 15);
		}
		return false;
	}
