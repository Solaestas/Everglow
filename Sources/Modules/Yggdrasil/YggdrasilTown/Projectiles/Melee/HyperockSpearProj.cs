...
public class HyperockSpearProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        else
        {
            ...
            Projectile.timeLeft = 1500;
            Projectile.velocity = (Main.MouseWorld - player.MountedCenter).SafeNormalize(new Vector2(0, -1 * player.gravDir));
        ...
        {
            Shot = true;
            Projectile.velocity = (Main.MouseWorld - player.MountedCenter).SafeNormalize(new Vector2(0, -1 * player.gravDir)) * (Power + 40) / 4f;
