...
namespace Everglow.Yggdrasil.YggdrasilTown.Items.Tools
{
    internal class AmberFlowerHook : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<AmberFlowerHookProjectile>(); // Makes the item shoot the hook's projectile when used.
    ...
    internal class AmberFlowerHookProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModAsset.AmberFlowerHook_Chain;
        }
		...
		*/
        ...
        {
            speed = 28f; // How fast the grapple returns to you after meeting its max shoot distance
        }

        public override void GrapplePullSpeed(Player player, ref float speed)
        {
            speed = 17.5f; // How fast you get pulled to the grappling hook projectile's landing position
        }
