...
public class JellyBallCurrentBeam : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.JellyBallCurrentBeam;
...
[Pipeline(typeof(JellyBallCurrentBeam), typeof(BloomPipeline))]
public class JellyBallCurrentBeamDust : Visual
{
	...
	private float scaleCoef = Main.rand.NextFloat(3.0f, 10f);

	public JellyBallCurrentBeamDust()
	{
	}
