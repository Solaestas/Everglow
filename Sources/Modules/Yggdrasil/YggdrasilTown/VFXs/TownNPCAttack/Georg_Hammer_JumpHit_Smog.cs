...
public class Georg_Hammer_JumpHit_SmogPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.Georg_Hammer_JumpHit_Smog;
	}
	...
	public override void BeginRender()
	{
		...
		Ins.Batch.BindTexture<Vertex2D>(ModAsset.Georg_Hammer_JumpHit_Smog_heatmap.Value);
...
[Pipeline(typeof(Georg_Hammer_JumpHit_SmogPipeline))]
public class Georg_Hammer_JumpHit_Smog : Visual
{
