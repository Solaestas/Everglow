...
public class BettyWatermelonPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.BettyWatermelonSmog;
	}
	...
	public override void BeginRender()
	{
		...
		effect.Parameters["uHeatMap"].SetValue(ModAsset.HeatMap_BettyWatermelon.Value);
...
[Pipeline(typeof(BettyWatermelonPipeline))]
public class BettyWatermelonDust : Visual
{
