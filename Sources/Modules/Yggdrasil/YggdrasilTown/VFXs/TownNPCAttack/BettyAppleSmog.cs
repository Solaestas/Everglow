...
public class BettyApplePipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.BettyAppleSmog;
	}
	...
	public override void BeginRender()
	{
		...
		effect.Parameters["uHeatMap"].SetValue(ModAsset.HeatMap_BettyApple.Value);
...
[Pipeline(typeof(BettyApplePipeline))]
public class BettyAppleDust : Visual
{
