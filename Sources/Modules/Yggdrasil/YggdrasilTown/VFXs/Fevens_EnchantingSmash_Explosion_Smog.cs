...
public class Fevens_EnchantingSmash_Explosion_SmogPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.Fevens_EnchantingSmash_Explosion_Smog;
	}
	...
	public override void BeginRender()
	{
		...
		Ins.Batch.BindTexture<Vertex2D>(ModAsset.Fevens_EnchantingSmash_Explosion_Smog_heatmap.Value);
...
[Pipeline(typeof(Fevens_EnchantingSmash_Explosion_SmogPipeline))]
public class Fevens_EnchantingSmash_Explosion_Smog : Visual
{
