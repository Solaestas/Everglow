...
public class Fevens_WingSmashPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.Fevens_WingSmash_fog;
	}
	...
	public override void BeginRender()
	{
		...
		Ins.Batch.BindTexture<Vertex2D>(ModAsset.Fevens_WingSmash_heatmap.Value);
...
[Pipeline(typeof(Fevens_WingSmashPipeline))]
public class Fevens_WingSmash : Visual
{
	...
	public override void Draw()
	{
		...
		for (int i = 1; i < len; i++)
		{
			...
			var lightColorWithPos = new Color(MathF.Pow(fx, 0.4f), 1f, 1f, 1f);
		...
		if (len <= 2)
		{
			for (int i = 1; i < 3; i++)
			{
				var lightColorWithPos = new Color(1f, 1f, 1f, 1f);
