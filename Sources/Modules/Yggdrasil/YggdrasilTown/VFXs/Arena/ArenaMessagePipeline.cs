...
public class ArenaMessagePipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.ArenaMessageBackgroundDissolve_Success;
	}
	...
	public override void BeginRender()
	{
		...
		effect.Parameters["uHeatMap"].SetValue(ModAsset.HeatMap_Success.Value);
