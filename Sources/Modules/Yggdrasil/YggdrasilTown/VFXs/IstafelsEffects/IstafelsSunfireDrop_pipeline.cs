...
public class IstafelsSunfireDropPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.IstafelsSunfireDrop;
	}
	...
	public override void BeginRender()
	{
		...
		effect.Parameters["uHeatMap"].SetValue(ModAsset.HeatMap_IstafelsSunfireDrop.Value);
