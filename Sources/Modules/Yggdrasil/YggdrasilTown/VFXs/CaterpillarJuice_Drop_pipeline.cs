...
public class CaterpillarJuicePipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.CaterpillarJuice_Drop;
	}
	...
	public override void BeginRender()
	{
		...
		effect.Parameters["uHeatMap"].SetValue(ModAsset.HeatMap_CaterpillarJuice_Drop.Value);
