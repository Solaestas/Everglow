...
public class CyanLotusFlameDust : Visual
{
	public float Timer;
	...
	public override void Update()
	{
		...
		if (pocession > 0.5f)
		{
			flame = Color.Lerp(new Color(0f, 1f, 0.96f, 0), new Color(1f, 1f, 1f, 0), (pocession - 0.5f) * 2f);
		}
		else
		{
			flame = Color.Lerp(new Color(0f, 0.45f, 0.42f, 0.3f), new Color(0f, 1f, 0.96f, 0), pocession * 2f);
		}
	...
	public override void Draw()
	{
		...
		if (pocession > 0.5f)
		{
			flame = Color.Lerp(new Color(0f, 0.75f, 0.72f, 0), new Color(1f, 1f, 1f, 0), (pocession - 0.5f) * 2f);
		}
		else
		{
			flame = Color.Lerp(new Color(0f, 0.15f, 0.12f, 0.3f), new Color(0f, 0.75f, 0.72f, 0), pocession * 2f);
		}
		flame.A = 100;
		if (MaxTime - Timer < 10f)
		{
		...
		Ins.Batch.Draw(ModAsset.CyanLotusFlameDust.Value, bars, PrimitiveType.TriangleStrip);
	}
}