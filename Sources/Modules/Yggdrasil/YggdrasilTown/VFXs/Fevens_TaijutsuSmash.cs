...
public class Fevens_TaijutsuSmashPipeline : Pipeline
{
	public override void Load()
	{
		effect = ModAsset.Fevens_TaijutsuSmash_fog;
	}
	...
	public override void BeginRender()
	{
		...
		Ins.Batch.BindTexture<Vertex2D>(ModAsset.Fevens_TaijutsuSmash_heatmap.Value);
...
[Pipeline(typeof(Fevens_TaijutsuSmashPipeline))]
public class Fevens_TaijutsuSmash : Visual
{
	...
	public override void Draw()
	{
		...
		for (int i = 1; i < len; i++)
		{
			...
			var lightColorWithPos = new Color(MathF.Pow(fx, 0.3f), 1f, 1f, 1f);
