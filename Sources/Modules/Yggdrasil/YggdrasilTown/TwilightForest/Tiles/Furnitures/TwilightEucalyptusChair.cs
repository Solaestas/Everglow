...
public class TwilightEucalyptusChair : ModTile
{
	...
	{
		FurnitureUtils.ChairMouseOver<Everglow.Yggdrasil.YggdrasilTown.TwilightForest.Items.Furnitures.TwilightEucalyptusChair>(i, j);
	}
}