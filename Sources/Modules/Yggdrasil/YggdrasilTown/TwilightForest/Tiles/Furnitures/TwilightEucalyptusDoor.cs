...
public class TwilightEucalyptusDoor : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		RegisterItemDrop(ModContent.ItemType<Everglow.Yggdrasil.YggdrasilTown.TwilightForest.Items.Furnitures.TwilightEucalyptusDoor>(), 0);
		TileID.Sets.CloseDoorID[Type] = ModContent.TileType<TwilightEucalyptusDoorClosed>();
	...
	public override void MouseOver(int i, int j)
	{
		...
		player.cursorItemIconID = ModContent.ItemType<Everglow.Yggdrasil.YggdrasilTown.TwilightForest.Items.Furnitures.TwilightEucalyptusDoor>();
	}
}