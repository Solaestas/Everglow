...
public class TwilightEucalyptusToilet : ModTile
{
	...
	public override void MouseOver(int i, int j)
	{
		...
		player.cursorItemIconID = ModContent.ItemType<Everglow.Yggdrasil.YggdrasilTown.TwilightForest.Items.Furnitures.TwilightEucalyptusToilet>();
