...
public class TwilightEucalyptusSofa_Type2 : ModTile
{
	...
	{
		FurnitureUtils.SofaMouseOver<Everglow.Yggdrasil.YggdrasilTown.TwilightForest.Items.Furnitures.TwilightEucalyptusSofa_Type2>(i, j);
	}
}