...
public class BacterialAgent_explosion : ModProjectile, IWarpProjectile
{
	...
	public void DrawWarp(VFXBatch spriteBatch)
	{
		...
		DrawTexCircle_VFXBatch(spriteBatch, MathF.Sqrt(value) * 11f, 12 * (1 - value), new Color(colorV, colorV * 0.6f, colorV, 0f), Projectile.Center - Main.screenPosition, t, Math.PI * 0.5);
	}
