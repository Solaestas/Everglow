...
public class IslePeachTree_wall_small : ModTile, ITileFluentlyDrawn
{
	...
	private void DrawPeachTree(Point tilePos, Vector2 drawCenterPos, SpriteBatch spriteBatch, TileDrawing tileDrawing)
	{
		...
		float highestWindGridPushComplex = tileDrawing.GetHighestWindGridPushComplex(tilePos.X - 2, tilePos.Y - 1, 5, 2, totalPushTime, pushForcePerFrame, 3, swapLoopDir: true);
