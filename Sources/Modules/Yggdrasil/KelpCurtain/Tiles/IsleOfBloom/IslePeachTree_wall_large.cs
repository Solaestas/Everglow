...
public class IslePeachTree_wall_large : ModTile, ITileFluentlyDrawn
{
	...
	private void DrawPeachTree(Point tilePos, Vector2 drawCenterPos, SpriteBatch spriteBatch, TileDrawing tileDrawing)
	{
		...
		tex = PaintedTextureSystem.TryGetPaintedTexture(ModAsset.IslePeachTree_wall_large_Path, Type, 1, paint, tileDrawing);
		tex ??= ModAsset.IslePeachTree_wall_large.Value;
		...
		{
			case 0:
				frame = new Rectangle(18, 28, 278, 96);
				origin = new Vector2(151, 86);
				break;
			case 1:
				frame = new Rectangle(312, 12, 302, 110);
