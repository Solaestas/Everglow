...
public class WaterErodedChestInlaidWithGold : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		DustType = ModContent.DustType<WaterErodedChestInlaidWithGoldDust>();
	...
	public override void MouseOver(int i, int j)
	{
		...
		else
		{
			...
			{
				player.cursorItemIconID = ModContent.ItemType<WaterErodedChestInlaidWithGold_Item>();
