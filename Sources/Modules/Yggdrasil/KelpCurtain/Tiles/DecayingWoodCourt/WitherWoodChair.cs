...
public class WitherWoodChair : ModTile
{
	...
	{
		FurnitureUtils.ChairMouseOver<Everglow.Yggdrasil.KelpCurtain.Items.Placeables.DecayingWoodCourt.WitherWoodChair>(i, j);
	}
}