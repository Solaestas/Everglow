...
public class WitherWoodDoor : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		RegisterItemDrop(ModContent.ItemType<Everglow.Yggdrasil.KelpCurtain.Items.Placeables.DecayingWoodCourt.WitherWoodDoor>(), 0);
		TileID.Sets.CloseDoorID[Type] = ModContent.TileType<WitherWoodDoorClosed>();
	...
	public override void MouseOver(int i, int j)
	{
		...
		player.cursorItemIconID = ModContent.ItemType<Everglow.Yggdrasil.KelpCurtain.Items.Placeables.DecayingWoodCourt.WitherWoodDoor>();
	}
}