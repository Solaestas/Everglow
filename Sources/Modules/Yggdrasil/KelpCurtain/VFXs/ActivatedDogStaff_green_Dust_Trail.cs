...
public class ActivatedDogStaff_green_Dust_Trail : Visual
{
	...
	public override void Draw()
	{
		...
		gradientColor.colorList.Add((new Color(89, 255, 122, 0), 0));
		gradientColor.colorList.Add((new Color(6, 132, 0, 0), 0.2f));
		...
		for (int i = 0; i < trails.Count; i++)
		{
			...
			bars.Add(pos + toCorner.RotatedBy(Math.PI * 1 + rotation) * size, drawColor, new Vector3(1, 0, 0));
			bars.Add(pos + toCorner.RotatedBy(Math.PI * 0.5 + rotation) * size, drawColor, new Vector3(0, 0, 0));
			bars.Add(pos + toCorner.RotatedBy(Math.PI * 0 + rotation) * size, drawColor, new Vector3(0, 1, 0));

			bars.Add(pos + toCorner.RotatedBy(Math.PI * -0.5 + rotation) * size, drawColor, new Vector3(1, 1, 0));
			bars.Add(pos + toCorner.RotatedBy(Math.PI * 0 + rotation) * size, drawColor, new Vector3(0, 1, 0));
			bars.Add(pos + toCorner.RotatedBy(Math.PI * 1 + rotation) * size, drawColor, new Vector3(1, 0, 0));
		}
