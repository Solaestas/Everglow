...
float4 PixelShaderFunction(PSInput input) : COLOR0
{
	...
	float redComponent = 0.3f + 0.1f * sin(timeFactorWithTexCoordX * 1.5f);
	float greenComponent = 0.9f + 0.2f * cos(timeFactorWithTexCoordY);
	float blueComponent = 0.3f + 0.1f * sin(timeFactorWithTexCoordX);
