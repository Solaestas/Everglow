    ...
    public class RedSpongeGun : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            for (int h = 0; h < 3; h++)
            {
                ...
                int num = Projectile.NewProjectile(position.X + speedX + v.X, position.Y + speedY + v.Y + 5f, v.X, v.Y, mod.ProjectileType("RedSponge"), damage * 2, knockBack, player.whoAmI, 0f, 0f);
            }
            return false;
		}
