...
namespace Everglow.Ocean.Tiles.Ocean
{
    ...
    public class 巨大橙色海绵 : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, base.Mod.Find<ModItem>("HugeOrangeSponge").Type);
        }
        public override void PlaceInWorld(int i, int j, Item item)
        {
            short num = (short)(Main.rand.Next(0, 4));
            Main.tile[i, j].TileFrameX = (short)(num * 162);
            Main.tile[i, j + 2].TileFrameX = (short)(num * 162);
            Main.tile[i, j - 1].TileFrameX = (short)(num * 162);
            Main.tile[i, j + 3].TileFrameX = (short)(num * 162);
            Main.tile[i, j + 1].TileFrameX = (short)(num * 162);
            Main.tile[i, j - 2].TileFrameX = (short)(num * 162);
            Main.tile[i, j - 3].TileFrameX = (short)(num * 162);
            Main.tile[i, j - 4].TileFrameX = (short)(num * 162);
        }
    }
}
