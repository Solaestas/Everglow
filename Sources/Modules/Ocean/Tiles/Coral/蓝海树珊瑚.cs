...
namespace Everglow.Ocean.Tiles
{
	...
	public class 蓝海树珊瑚 : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            base.AddMapEntry(new Color(16, 86, 208), modTranslation);
        }
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(null, i * 16, j * 16, 16, 32, ModContent.ItemType<Everglow.Ocean.Items.BlueTreeCoral>());
        }
