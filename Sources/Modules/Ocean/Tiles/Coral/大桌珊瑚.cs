...
namespace MythMod.Tiles.Ocean
{
	...
	public class 大桌珊瑚 : ModTile
	{
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 48, mod.ItemType("TableCoral"), 1, false, 0, false, false);
        }
        public override void PlaceInWorld(int i, int j, Item item)
        {
            short num = (short)(Main.rand.Next(0, 4));
            Main.tile[i, j].frameX = (short)(num * 108);
            Main.tile[i, j + 2].frameX = (short)(num * 108);
            Main.tile[i, j + 1].frameX = (short)(num * 108);
        }
    }
}
