...
namespace Everglow.Ocean.Tiles
{
	...
	public class 黄色小海绵 : ModTile
	{
        ...
        {
            Item.NewItem(null, i * 16, j * 16, 16, 32, ModContent.ItemType<Everglow.Ocean.Items.YellowLittleSponge>());
        }
        ...
        {
            short num = (short)(Main.rand.Next(0, 8) * 18);
