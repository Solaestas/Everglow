    ...
    public class OceanCrystalEye1 : ModNPC
	{
        ...
        public override void AI()
        {
            ...
            if(npc.localAI[0] % 120 == 0)
            {
                ...
                Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, v.X, v.Y, base.mod.ProjectileType("蔚蓝射线2"), (int)(base.npc.damage * 0.2f), 0.2f, Main.myPlayer, 0f, 0f);
            }
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector2 -= new Vector2((float)base.mod.GetTexture("NPCs/OceanCrystal/海洋封印之眼1Glow").Width, (float)(base.mod.GetTexture("NPCs/OceanCrystal/海洋封印之眼1Glow").Height / Main.npcFrameCount[base.npc.type])) * 1f / 2f;
            vector2 += vector * 1f + new Vector2(0f, 4f + base.npc.gfxOffY);
            Color color = Utils.MultiplyRGBA(new Color(297 - base.npc.alpha, 297 - base.npc.alpha, 297 - base.npc.alpha, 0), Color.Blue);
            Main.spriteBatch.Draw(base.mod.GetTexture("NPCs/OceanCrystal/海洋封印之眼1Glow"), vector2, new Rectangle?(base.npc.frame), color, z, vector, 1f, effects, 0f);
            Main.spriteBatch.Draw(base.mod.GetTexture("NPCs/OceanCrystal/海洋封印之眼1Glow"), vector2, new Rectangle?(base.npc.frame), color, -z, vector, 1f, effects, 0f);
        }
