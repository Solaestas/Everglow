		...
		if (Projectile.penetrate >= 2)
		{
			if (Projectile.ai[1] != 9999)
			{
				for (int l = 0; l < 10; l++)
				{
					...
					int h = Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, v.X, v.Y, Mod.Find<ModProjectile>("AquamarineStaffPro").Type, Projectile.damage, Projectile.knockBack, Main.myPlayer, 9999, 9999);
