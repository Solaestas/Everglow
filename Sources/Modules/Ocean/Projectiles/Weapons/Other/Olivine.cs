...
namespace Everglow.Ocean.Projectiles.projectile2
{
    ...
    public class Olivine : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            {
                int num3 = Dust.NewDust(base.Projectile.Center - base.Projectile.velocity * 4f - new Vector2(4, 4), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Olivine>(), 0, 0, 0, default(Color), 1.6f);
            ...
            {
                int num3 = Dust.NewDust(base.Projectile.Center - base.Projectile.velocity * 4f - new Vector2(4, 4), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Olivine>(), 0, 0, 0, default(Color), 1.6f * Projectile.timeLeft / 120f);
                Main.dust[num3].noGravity = true;
                Main.dust[num3].velocity = new Vector2(0, 0);
