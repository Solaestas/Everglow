...
namespace Everglow.Ocean.Projectiles
{
    public class WaveBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int j = 0; j < 90; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Wave>(), 0f, 0f, 100, default(Color), 2f);
            ...
            for (int j = 0; j < 90; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Wave2>(), 0f, 0f, 100, default(Color), 6f);
            ...
            for (int j = 0; j < 60; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Wave>(), 0f, 0f, 100, default(Color), 1f);
            ...
            for (int j = 0; j < 60; j++)
            {
                int num2 = Dust.NewDust(new Vector2(base.Projectile.Center.X, base.Projectile.Center.Y), 0, 0, ModContent.DustType<Everglow.Ocean.Dusts.Wave2>(), 0f, 0f, 100, default(Color), 3f);
