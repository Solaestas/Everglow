...
namespace MythMod.NPCs
{
    ...
    public class AlernJellyfish : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			base.npc.value = (float)Item.buyPrice(0, 25, 12, 0);
			base.npc.HitSound = SoundID.NPCHit25;
			base.npc.DeathSound = SoundID.NPCDeath28;
			this.banner = base.npc.type;
			this.bannerItem = base.mod.ItemType("AlarmJellyfishBanner");
		}
		...
		public override void AI()
		{
			...
			if (!base.npc.wet)
			{
				base.npc.rotation += base.npc.velocity.X * 0.8f;
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector2 -= new Vector2((float)base.mod.GetTexture("NPCs/警报水母光辉").Width, (float)(base.mod.GetTexture("NPCs/警报水母光辉").Height / Main.npcFrameCount[base.npc.type])) * 1f / 2f;
            vector2 += vector * 1f + new Vector2(0f, 4f + base.npc.gfxOffY);
            Color color = Utils.MultiplyRGBA(new Color(297 - base.npc.alpha, 297 - base.npc.alpha, 297 - base.npc.alpha, 0), Color.Blue);
            Main.spriteBatch.Draw(base.mod.GetTexture("NPCs/警报水母光辉"), vector2, new Rectangle?(base.npc.frame), color, base.npc.rotation, vector, 1f, effects, 0f);
        }
		...
		public override void OnHitPlayer(Player player, int damage, bool crit)
		{
            ...
            player.AddBuff(base.mod.BuffType("极剧毒"), 32, true);
		}
        ...
        public override void NPCLoot()
        {
            ...
            if (Main.rand.Next(3) == 0)
            {
                Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, base.mod.ItemType("海因子"), 1, false, 0, false, false);
            }
            if (Main.rand.Next(175) == 0 && Main.hardMode)
            {
                Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, base.mod.ItemType("幽渊之光"), 1, false, 0, false, false);
            }
        }
	}
}
