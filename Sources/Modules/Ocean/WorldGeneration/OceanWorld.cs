...
namespace Everglow.Ocean.WorldGeneration.OceanWorld;

internal class OceanWorld : Subworld
{
	...
	{
		new OceanGen.OceanGen.OceanWorldGenPass()
	};
	public override void DrawMenu(GameTime gameTime)
	{
		Texture2D MenuUG2SBG = ModAsset.CoralFar.Value;
