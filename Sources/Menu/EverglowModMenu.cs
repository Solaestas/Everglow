...
namespace Everglow.Sources.Menu
{
    internal class EverglowModMenu : ModMenu
    {
        ...
        public void DrawBackGround()//天、星月
        {
            ...
            tex = ModContent.Request<Texture2D>("Everglow/Sources/Menu/bg").Value;
            ...
            Texture2D moon = ModContent.Request<Texture2D>("Everglow/Sources/Menu/Moon").Value;
        ...
        public override bool PreDrawLogo(SpriteBatch spriteBatch, ref Vector2 logoDrawCenter, ref float logoRotation, ref float logoScale, ref Color drawColor)
        {
            ...
            //绘制前置两层
            Texture2D front2 = ModContent.Request<Texture2D>("Everglow/Sources/Menu/front2").Value;
